        ...
        _createClass(RequestDetailsComponent, [{
          ...
          value: function openEditResponseLatencyDialog() {
            ...
            var onCreateSub = dialogRef.componentInstance.onEdit.subscribe(function (updatedRequest) {
              _this10.requestResource.update(_this10.request.id, {
                latency: updatedRequest.latency
              }).subscribe(function (res) {
                _this10.request.latency = updatedRequest.latency;
              });
            });
            dialogRef.afterClosed().subscribe(function () {
              onCreateSub.unsubscribe();
            ...
            switch ($event.tab.textLabel) {
              case this.headerTitle:
                this.headerResource.index(this.request.id, defaultQueryParams).subscribe(function (res) {
                  _this11.headerData = res.map(function (header) {
              ...
              case this.queryParamTitle:
                this.queryParamResource.index(this.request.id, defaultQueryParams).subscribe(function (res) {
                  _this11.queryParamData = res.map(function (queryParam) {
              ...
              case this.bodyParamTitle:
                this.bodyParamResource.index(this.request.id, defaultQueryParams).subscribe(function (res) {
                  _this11.bodyParamData = res.map(function (bodyParam) {
          ...
          value: function sendRequest() {
            ...
            this.requestResource.show(this.request.id, {
              ...
              _this12.agentService.sendRequest(new _data_schema__WEBPACK_IMPORTED_MODULE_8__["Request"](res)).subscribe(function (res) {
                console.log(res);
              });
            });
          }
