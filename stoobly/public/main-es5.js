(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    /***/
    function f9C(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function fow(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "PathSegment", function () {
        return PathSegment;
      });
      /* harmony import */


      var _request_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./request-component */
      "2bXN");

      var PathSegment = /*#__PURE__*/function (_request_component__W) {
        _inherits(PathSegment, _request_component__W);

        var _super = _createSuper(PathSegment);

        function PathSegment(pathSegment) {
          var _this;

          _classCallCheck(this, PathSegment);

          _this = _super.call(this, 2, pathSegment.id, pathSegment.alias);
          _this.position = pathSegment.position;
          _this.name = pathSegment.name;
          _this.aliasName = pathSegment.alias_name;
          return _this;
        }

        return PathSegment;
      }(_request_component__WEBPACK_IMPORTED_MODULE_0__["RequestComponent"]);
      /***/
        ...
        _createClass(ScrollbarDirective, [{
          ...
          value: function ngAfterContentInit() {
            ...
            this.zone.runOutsideAngular(function () {
              _this2.scrollbarRef = new simplebar__WEBPACK_IMPORTED_MODULE_2__["default"](_this2._element.nativeElement, _this2.options);
            });
          }
        }]);
    ...
    function JUU(module, __webpack_exports__, __webpack_require__) {
      ...
      var _core_utils_uri_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var AgentService = /*#__PURE__*/function () {
        function AgentService(httpService, uri) {
        ...
        _createClass(AgentService, [{
          key: "showStatus",
          value: function showStatus(statusId) {
            return this.sendGetRequest("".concat(this.STATUSES_ENDPOINT, "/").concat(statusId));
          }
        }, {
          key: "showConfigsModes",
          value: function showConfigsModes() {
            return this.sendGetRequest("".concat(this.CONFIGS_ENDPOINT, "/modes"));
          }
        }, {
          key: "showConfigsPolicies",
          value: function showConfigsPolicies() {
            return this.sendGetRequest("".concat(this.CONFIGS_ENDPOINT, "/policies"));
          }
        }, {
          key: "showConfig",
          value: function showConfig(queryParams) {
            return this.sendGetRequest(this.CONFIGS_ENDPOINT, queryParams);
          }
        }, {
          key: "createConfig",
          value: function createConfig(body) {
            return this.sendPostRequest(this.CONFIGS_ENDPOINT, body);
          }
        }, {
          key: "updateConfig",
          value: function updateConfig(body) {
            return this.sendPutRequest("".concat(this.CONFIGS_ENDPOINT), body);
          }
        }, {
          key: "sendRequest",
          value: function sendRequest(request) {
            var uri = new this.uri["class"](request.url);
            var headers = {
              SERVICE_URL_HEADER: uri.origin
            };
            ...
            if (request.queryParams) {
              request.queryParams.forEach(function (queryParam) {
            ...
            switch (request.method) {
              case 'GET':
                observable = this.sendGetRequest(uri.pathname, queryParams, {
                  headers: headers
                });
            }
          ...
          key: "sendGetRequest",
          value: function sendGetRequest(path, queryParams, options) {
            var url = "".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].agentUrl).concat(path);
            return this.httpService.get(url, queryParams, options);
          }
        }, {
          key: "sendPostRequest",
          value: function sendPostRequest(path, body, options) {
            var url = "".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].agentUrl).concat(path);
            return this.httpService.post(url, body, options);
          }
        }, {
          key: "sendPutRequest",
          value: function sendPutRequest(path, body, options) {
            var url = "".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].agentUrl).concat(path);
      ...
      AgentService.ctorParameters = function () {
        return [{
      ...
      AgentService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], AgentService);
      /***/
    },
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /home/jvlarble/bitbucket/stoobly-dashboard/src/main.ts */
      "zUnb");
      /***/
    },
      ...
      module.exports = {
        ...
        plugins: [function (_ref2) {
          var addVariant = _ref2.addVariant,
              e = _ref2.e;
          addVariant('ltr', function (_ref3) {
            var separator = _ref3.separator,
                modifySelectors = _ref3.modifySelectors;
            modifySelectors(function (_ref4) {
              var className = _ref4.className;
              return "[dir=ltr] .ltr".concat(e(separator)).concat(className);
            });
          });
          addVariant('rtl', function (_ref5) {
            var separator = _ref5.separator,
                modifySelectors = _ref5.modifySelectors;
            modifySelectors(function (_ref6) {
    ...
    /***/
    function Fbs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function vXY(module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_config_panel_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./config-panel.component.html */
      "fQJz");
      /* harmony import */


      var _config_panel_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _iconify_icons_ic_twotone_settings__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-settings */
      "hF2C");
      /* harmony import */


      var _iconify_icons_ic_twotone_settings__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_settings__WEBPACK_IMPORTED_MODULE_7__);
      /* harmony import */
      ...
      var _interfaces_config_name_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var _services_style_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      ...
      var ConfigPanelComponent = /*#__PURE__*/function () {
        function ConfigPanelComponent(configService, styleService, layoutService, route) {
          ...
          this.activeConfig$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (config) {
            return Object.keys(_this3.configService.configs).find(function (key) {
              return _this3.configService.configs[key] === config;
            });
          }));
          this.isRTL$ = this.route.queryParamMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (paramMap) {
      ...
      ConfigPanelComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    /***/
    function RYP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function USq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function bXN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RequestComponentType", function () {
        return RequestComponentType;
      });

      var RequestComponent = function RequestComponent(type, id, alias) {
    ...
    function Ncz(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "ScenarioResource", function () {
      ...
      var ScenarioResource = /*#__PURE__*/function () {
        function ScenarioResource(restApi) {
          _classCallCheck(this, ScenarioResource);

          this.restApi = restApi;
          this.ENDPOINT = 'scenarios';
        }

        _createClass(ScenarioResource, [{
          key: "index",
          value: function index(queryParams) {
            return this.restApi.index([this.ENDPOINT], queryParams);
          }
        }, {
          key: "show",
          value: function show(id, queryParams) {
      ...
      ScenarioResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      ScenarioResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], ScenarioResource);
      /***/
    },
    ...
    /***/
    function aTg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ResponseResolverResource", function () {
        return ResponseResolverResource;
      });
      /* harmony import */
      ...
      var ResponseResolverResource = /*#__PURE__*/function () {
        function ResponseResolverResource(restApi) {
          _classCallCheck(this, ResponseResolverResource);
      ...
      ResponseResolverResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      ResponseResolverResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    function oZ8(module, __webpack_exports__, __webpack_require__) {
      ...
      var _interfaces_config_name_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ../interfaces/config-name.model */
      "EuI8");
      /* harmony import */
    ...
    /***/
    function v0u(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ToolbarUserDropdownIcons", function () {
        return ToolbarUserDropdownIcons;
      });
      /* harmony import */
      ...
      var _iconify_icons_ic_twotone_business__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-business */
      "6uZp");
      /* harmony import */


      var _iconify_icons_ic_twotone_business__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_business__WEBPACK_IMPORTED_MODULE_5__);
      /* harmony import */


      var _iconify_icons_ic_twotone_check_circle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-check-circle */
      "Z5gU");
      /* harmony import */


      var _iconify_icons_ic_twotone_check_circle__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_check_circle__WEBPACK_IMPORTED_MODULE_6__);
      /* harmony import */


      var _iconify_icons_ic_twotone_chevron_right__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-chevron-right */
      "uAX/");
      /* harmony import */


      var _iconify_icons_ic_twotone_chevron_right__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_chevron_right__WEBPACK_IMPORTED_MODULE_7__);
      /* harmony import */


      var _iconify_icons_ic_twotone_do_not_disturb__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-do-not-disturb */
      "8acV");
      /* harmony import */


      var _iconify_icons_ic_twotone_do_not_disturb__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_do_not_disturb__WEBPACK_IMPORTED_MODULE_8__);
      /* harmony import */


      var _iconify_icons_ic_twotone_list_alt__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-list-alt */
      "a5nG");
      /* harmony import */


      var _iconify_icons_ic_twotone_list_alt__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_list_alt__WEBPACK_IMPORTED_MODULE_9__);
      /* harmony import */


      var _iconify_icons_ic_twotone_lock__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-lock */
      "QR5W");
      /* harmony import */


      var _iconify_icons_ic_twotone_lock__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_lock__WEBPACK_IMPORTED_MODULE_10__);
      /* harmony import */


      var _iconify_icons_ic_twotone_notifications_off__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-notifications-off */
      "nu12");
      /* harmony import */


      var _iconify_icons_ic_twotone_notifications_off__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_notifications_off__WEBPACK_IMPORTED_MODULE_11__);
      /* harmony import */
      ...
      var _iconify_icons_ic_twotone_settings__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-settings */
      "hF2C");
      /* harmony import */


      var _iconify_icons_ic_twotone_settings__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_settings__WEBPACK_IMPORTED_MODULE_14__);
      /* harmony import */


      var _iconify_icons_ic_twotone_table_chart__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-table-chart */
      "qrwc");
      /* harmony import */


      var _iconify_icons_ic_twotone_table_chart__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_table_chart__WEBPACK_IMPORTED_MODULE_15__);
      /* harmony import */
      ...
      var ToolbarUserDropdownIcons = function ToolbarUserDropdownIcons() {
        _classCallCheck(this, ToolbarUserDropdownIcons);
      ...
      ToolbarUserDropdownIcons.ctorParameters = function () {
        return [];
      };

      ToolbarUserDropdownIcons = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    /***/
    function Wj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RequestResource", function () {
      ...
      var RequestResource = /*#__PURE__*/function () {
        function RequestResource(restApi) {
      ...
      RequestResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      RequestResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], RequestResource);
      /***/
    },
    ...
    /***/
    function GLy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AliasResource", function () {
      ...
      var AliasResource = /*#__PURE__*/function () {
        function AliasResource(restApi) {
          _classCallCheck(this, AliasResource);

          this.restApi = restApi;
          this.ENDPOINT = 'aliases';
        }

        _createClass(AliasResource, [{
          key: "index",
          value: function index(queryParams) {
            return this.restApi.index([this.ENDPOINT], queryParams);
          }
          ...
          key: "destroy",
          value: function destroy(id, queryParams) {
      ...
      AliasResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      AliasResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], AliasResource);
      /***/
    },
    ...
    function UAC(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "ProjectResource", function () {
      ...
      var ProjectResource = /*#__PURE__*/function () {
        function ProjectResource(restApi) {
      ...
      ProjectResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      ProjectResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], ProjectResource);
      /***/
    },
    ...
    /***/
    function mL1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function PI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _navigation_item_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      NavigationItemModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_navigation_item_component__WEBPACK_IMPORTED_MODULE_8__["NavigationItemComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_5__["MatMenuModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_7__["IconModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_4__["MatIconModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_3__["MatRippleModule"]],
    ...
    function Yx(module, __webpack_exports__, __webpack_require__) {
      ...
      ContainerModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
    ...
    /***/
    function lMm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function PN(module, __webpack_exports__, __webpack_require__) {
      ...
      var _vex_components_config_panel_config_panel_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! @vex/components/config-panel/config-panel.module */
      "mbJQ");
      /* harmony import */


      var _vex_components_footer_footer_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @vex/components/footer/footer.module */
      "TphN");
      /* harmony import */


      var _vex_components_quickpanel_quickpanel_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! @vex/components/quickpanel/quickpanel.module */
      "mQ6f");
      /* harmony import */


      var _vex_components_sidebar_sidebar_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! @vex/components/sidebar/sidebar.module */
      "zaci");
      /* harmony import */


      var _vex_layout_layout_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! @vex/layout/layout.module */
      "cwwZ");
      /* harmony import */


      var _vex_layout_sidenav_sidenav_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! @vex/layout/sidenav/sidenav.module */
      "W9UW");
      /* harmony import */


      var _components_toolbar_toolbar_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./components/toolbar/toolbar.module */
      "Hv0H");
      /* harmony import */


      var _custom_layout_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      ...
      CustomLayoutModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_custom_layout_component__WEBPACK_IMPORTED_MODULE_10__["CustomLayoutComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _vex_layout_layout_module__WEBPACK_IMPORTED_MODULE_7__["LayoutModule"], _vex_layout_sidenav_sidenav_module__WEBPACK_IMPORTED_MODULE_8__["SidenavModule"], _components_toolbar_toolbar_module__WEBPACK_IMPORTED_MODULE_9__["ToolbarModule"], _vex_components_footer_footer_module__WEBPACK_IMPORTED_MODULE_4__["FooterModule"], _vex_components_config_panel_config_panel_module__WEBPACK_IMPORTED_MODULE_3__["ConfigPanelModule"], _vex_components_sidebar_sidebar_module__WEBPACK_IMPORTED_MODULE_6__["SidebarModule"], _vex_components_quickpanel_quickpanel_module__WEBPACK_IMPORTED_MODULE_5__["QuickpanelModule"]]
      })], CustomLayoutModule);
      /***/
    },
    ...
    function JzS(module, __webpack_exports__, __webpack_require__) {
      ...
      var _sidenav_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _utils_track_by__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../../utils/track-by */
      "zK3P");
      ...
      var SidenavComponent = /*#__PURE__*/function () {
        function SidenavComponent(navigationService, layoutService, configService) {
          ...
          this.title$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (config) {
            return config.sidenav.title;
          }));
          this.imageUrl$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (config) {
            return config.sidenav.imageUrl;
          }));
          this.showCollapsePin$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (config) {
      ...
      SidenavComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    function vO(module, __webpack_exports__, __webpack_require__) {
      ...
      var Organization = function Organization(organization) {
    ...
    function D3(module, __webpack_exports__, __webpack_require__) {
      ...
      var angular_token__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! angular-token */
      "hU4o");
      /* harmony import */
      ...
      var _data_constants_route_constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! @data/constants/route.constants */
      "wZfh");

      var HttpErrorHandler = /*#__PURE__*/function () {
        function HttpErrorHandler(router, snackbar, tokenService) {
            ...
            switch (err.status) {
              case 401:
                this.tokenService.signOut().subscribe(function (res) {
                  _this5.router.navigate([_data_constants_route_constants__WEBPACK_IMPORTED_MODULE_6__["RouteConstants"].LOGIN_PAGE]);
                }, function (res) {
                  _this5.router.navigate([_data_constants_route_constants__WEBPACK_IMPORTED_MODULE_6__["RouteConstants"].LOGIN_PAGE]);
                });
                break;
      ...
      HttpErrorHandler = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], HttpErrorHandler);
      /***/
    },
    ...
    /***/
    function IoH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _plan__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./plan */
      "L3CV");

      var Subscription = function Subscription(subscription) {
    ...
    function IlP(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "UserResource", function () {
        return UserResource;
      });
      /* harmony import */
      ...
      var UserResource = /*#__PURE__*/function () {
        ...
        _createClass(UserResource, [{
          ...
          key: "profile",
          value: function profile(queryParams) {
          ...
          key: "subscription",
          value: function subscription(queryParams) {
            return this.restApi.show([this.ENDPOINT, 'subscription'], queryParams);
          }
        }, {
          key: "payments",
          value: function payments(queryParams) {
      ...
      UserResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      UserResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], UserResource);
      /***/
    },
    ...
    /***/
    function a6L(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_custom_layout_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./custom-layout.component.html */
      "+mfJ");
      /* harmony import */


      var _custom_layout_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _vex_utils_check_router_childs_data__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var CustomLayoutComponent = /*#__PURE__*/function () {
        function CustomLayoutComponent(layoutService, configService, breakpointObserver, router) {
          ...
          this.isFooterVisible$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (config) {
            return config.footer.visible;
          }));
          this.isDesktop$ = this.breakpointObserver.observe("(min-width: ".concat(_vex_utils_tailwindcss__WEBPACK_IMPORTED_MODULE_10__["default"].screens.lg, ")")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (state) {
            return state.matches;
          }));
          this.toolbarShadowEnabled$ = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (event) {
            return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_5__["NavigationEnd"];
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function () {
            return Object(_vex_utils_check_router_childs_data__WEBPACK_IMPORTED_MODULE_9__["checkRouterChildsData"])(_this6.router.routerState.root.snapshot, function (data) {
      ...
      CustomLayoutComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    /***/
    function AVA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "BodyParamNameResource", function () {
        return BodyParamNameResource;
      });
      /* harmony import */
      ...
      var BodyParamNameResource = /*#__PURE__*/function () {
        function BodyParamNameResource(restApi) {
          _classCallCheck(this, BodyParamNameResource);
        ...
        _createClass(BodyParamNameResource, [{
          key: "index",
          value: function index(endpointId, queryParams) {
      ...
      BodyParamNameResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      BodyParamNameResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    /***/
    function A4cF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      ColorFadePipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
        name: 'colorFade'
      })], ColorFadePipe);
      /***/
    },
    ...
    /***/
    function A8r0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function AKSP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function AQ4D(module, __webpack_exports__, __webpack_require__) {
      ...
      SplashScreenService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Injectable"])({
        providedIn: 'root'
      })], SplashScreenService);
      /***/
    },
    ...
    /***/
    function B1Wa(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "HeaderNameResource", function () {
        return HeaderNameResource;
      });
      /* harmony import */
      ...
      var HeaderNameResource = /*#__PURE__*/function () {
        function HeaderNameResource(restApi) {
          _classCallCheck(this, HeaderNameResource);
        ...
        _createClass(HeaderNameResource, [{
          key: "index",
          value: function index(endpointId, queryParams) {
            if (typeof endpointId === 'object') {
              queryParams = endpointId;
      ...
      HeaderNameResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      HeaderNameResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], HeaderNameResource);
      /***/
    },
    ...
    /***/
    function BjwJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var UriService = function UriService() {
        _classCallCheck(this, UriService);

        this["class"] = __webpack_require__(
        /*! url-parse */
        "GBY4");
      };
      ...
      UriService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], UriService);
      /***/
    },
    ...
    function C6sw(module, __webpack_exports__, __webpack_require__) {
      ...
      var _mega_menu_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./mega-menu.component */
      "pXZ5");
      ...
      MegaMenuModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_mega_menu_component__WEBPACK_IMPORTED_MODULE_7__["MegaMenuComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_6__["IconModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"]],
    ...
    /***/
    function C8Y(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function CTrj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Chvm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      ColorFadeModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
    ...
    /***/
    function Cq9o(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PathSegmentResource", function () {
        return PathSegmentResource;
      });
      /* harmony import */
      ...
      var PathSegmentResource = /*#__PURE__*/function () {
        function PathSegmentResource(restApi) {
          _classCallCheck(this, PathSegmentResource);
      ...
      PathSegmentResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      PathSegmentResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], PathSegmentResource);
      /***/
    },
    ...
    function CtTw(module, __webpack_exports__, __webpack_require__) {
      ...
      var LayoutService = /*#__PURE__*/function () {
        function LayoutService(router) {
          ...
          this.sidenavOpen$ = this._sidenavOpenSubject.asObservable(); // Controls whether sidenav is expanded false = expanded

          this._sidenavCollapsedSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](true);
          this.sidenavCollapsed$ = this._sidenavCollapsedSubject.asObservable(); // Controls whether sidenav is overlayed true = expanded
          ...
          this.sidenavOpen$.subscribe(function (e) {
            console.log('sidenavOpen');
            console.log(e);
          });
          this.sidenavCollapsed$.subscribe(function (e) {
            console.log('sidenavCollapsed');
            console.log(e);
          });
          this.sidenavCollapsedOpen$.subscribe(function (e) {
      ...
      LayoutService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], LayoutService);
      /***/
    },
    ...
    /***/
    function D14(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function D9MS(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "ProjectsUser", function () {
        return ProjectsUser;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "ProjectsUserRoles", function () {
        return ProjectsUserRoles;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "ProjectsUserRoleTitles", function () {
        return ProjectsUserRoleTitles;
      });

      var ProjectsUser = function ProjectsUser(projectsUser) {
        _classCallCheck(this, ProjectsUser);
    ...
    /***/
    function DdkG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function FKU7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SubscriptionResource", function () {
      ...
      var SubscriptionResource = /*#__PURE__*/function () {
        function SubscriptionResource(restApi) {
          _classCallCheck(this, SubscriptionResource);

          this.restApi = restApi;
          this.ENDPOINT = 'subscriptions';
        }

        _createClass(SubscriptionResource, [{
          key: "index",
          value: function index(queryParams) {
            return this.restApi.index([this.ENDPOINT], queryParams);
          }
      ...
      SubscriptionResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      SubscriptionResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    /***/
    function FKbl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OrganizationsUser", function () {
        return OrganizationsUser;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "OrganizationsUserRoles", function () {
        return OrganizationsUserRoles;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "OrganizationsUserRoleTitles", function () {
        return OrganizationsUserRoleTitles;
      });

      var OrganizationsUser = function OrganizationsUser(organizationsUser) {
        _classCallCheck(this, OrganizationsUser);
    ...
    /***/
    function FYDM(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ToolbarMockSettingsComponent", function () {
        return ToolbarMockSettingsComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_toolbar_mock_settings_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./toolbar-mock-settings.component.html */
      "Ys2n");
      /* harmony import */


      var _toolbar_mock_settings_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./toolbar-mock-settings.component.scss */
      "4mL1");
      /* harmony import */
      ...
      var _core_http_agent_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! @core/http/agent.service */
      "/JUU");
      /* harmony import */
      ...
      var _projects_services_project_data_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! @projects/services/project-data.service */
      "oyjd");
      /* harmony import */


      var _projects_services_projects_data_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! @projects/services/projects-data.service */
      "mbNh");
      /* harmony import */


      var _users_services_user_data_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! @users/services/user-data.service */
      "O7ya");
      /* harmony import */


      var _schema_agent_config__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ../../schema/agent-config */
      "nmZq");

      var ToolbarMockSettingsComponent = /*#__PURE__*/function () {
        function ToolbarMockSettingsComponent(dialogRef, fb, agentService, projectDataService, projectsDataService, scenarioResource, userDataService) {
          _classCallCheck(this, ToolbarMockSettingsComponent);
        ...
        _createClass(ToolbarMockSettingsComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this9 = this;
            ...
            this.initializeConfig().subscribe(function (res) {
              _this9.initializeProjects$(_this9.config);

              _this9.initializeProject(_this9.config);

              _this9.initializeScenarios(_this9.config);
            });
          } // API Access

        }, {
          key: "getScenarios",
          value: function getScenarios(projectId) {
            var _this10 = this;
            ...
            return this.scenarioResource.index({
              ...
              _this10.scenarios = res.list;
            }));
          } // View Access

        }, {
          key: "clearScenario",
          value: function clearScenario() {
            this.form.patchValue({
              scenario: null
            });
          }
        }, {
          key: "addIncludePattern",
          value: function addIncludePattern(pattern) {
            var includePatterns = this.form.get('includePatterns');
          ...
          key: "removeIncludePattern",
          value: function removeIncludePattern(index) {
            var includePatterns = this.form.get('includePatterns');
            includePatterns.removeAt(index);
          }
        }, {
          key: "addExcludePattern",
          value: function addExcludePattern(pattern) {
            var excludePatterns = this.form.get('excludePatterns');
            excludePatterns.push(this.fb.group({
              pattern: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](pattern || '', [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required])
            }));
          }
        }, {
          key: "removeExcludePattern",
          value: function removeExcludePattern(index) {
            var excludePatterns = this.form.get('excludePatterns');
          ...
          value: function update() {
            ...
            var user = this.userDataService.user;
            var project = formValue.project;
            var config = {
              mode: {
                mock: {
                  exclude_patterns: formValue.excludePatterns.map(function (data) {
                    return data.pattern;
                  }),
                  include_patterns: formValue.includePatterns.map(function (data) {
                    return data.pattern;
                  }),
            ...
            if (formValue.scenario) {
              var scenario = formValue.scenario;
            ...
            if (this.config) {
              this.agentService.updateConfig(config).subscribe(function (res) {
                _this11.dialogRef.close();
              });
            } else {
              this.agentService.createConfig(config).subscribe(function (res) {
                _this11.dialogRef.close();
              });
            }
          }
          ...
          key: "initializePolicies",
          value: function initializePolicies() {
            var _this12 = this;

            this.agentService.showConfigsPolicies().subscribe(function (res) {
              _this12.policies = Object.values(res);
            });
          }
        }, {
          key: "initializeConfig",
          value: function initializeConfig() {
            var _this13 = this;

            return this.agentService.showConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (res) {
              var config = res;

              if (config) {
                _this13.config = new _schema_agent_config__WEBPACK_IMPORTED_MODULE_14__["AgentConfig"](config);

                _this13.form.patchValue({
                  matchPatterns: _this13.config.mode.mock.matchPatterns,
                  mockPolicy: _this13.config.mode.mock.policy,
                  serviceUrl: _this13.config.mode.mock.serviceUrl
                });

                _this13.config.mode.mock.includePatterns.forEach(function (pattern) {
                  _this13.addIncludePattern(pattern);
                });

                _this13.config.mode.mock.excludePatterns.forEach(function (pattern) {
                  _this13.addExcludePattern(pattern);
                });
              }
            }));
          ...
          key: "initializeProjects$",
          value: function initializeProjects$(config) {
            if (!this.projectsDataService.projects) {
              var organizationId = this.projectDataService.project.organizationId;
          ...
          value: function initializeProject(config) {
            var _this14 = this;
          ...
          key: "initializeScenarios",
          value: function initializeScenarios(config) {
            var _this15 = this;

            if (this.project) {
              this.getScenarios(this.project.id).subscribe(function (res) {
                _this15.scenarios.some(function (scenario) {
                  if (config.mode.mock.scenarioKey === scenario.key) {
                    _this15.form.patchValue({
                      scenario: scenario
                    });
      ...
      ToolbarMockSettingsComponent.ctorParameters = function () {
        return [{
      ...
      ToolbarMockSettingsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function G605(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function GK0M(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Gg42(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AgentInterceptor", function () {
      ...
      var _core_http_agent_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! @core/http/agent.service */
      "/JUU");
      /* harmony import */


      var _core_utils_uri_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! @core/utils/uri.service */
      "BjwJ");
      /* harmony import */
      ...
      var AgentInterceptor = /*#__PURE__*/function () {
        function AgentInterceptor(uri, mockApiService) {
          _classCallCheck(this, AgentInterceptor);

          this.uri = uri;
          this.mockApiService = mockApiService;
        }

        _createClass(AgentInterceptor, [{
          key: "intercept",
          value: function intercept(req, next) {
            if (!_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].agentUrl) {
              ...
              var headers = req.headers.append(this.mockApiService.DO_PROXY_HEADER, '1'); // append(this.mockApiService.SERVICE_URL_HEADER, serviceUrl ? serviceUrl : environment.apiUrl);
      ...
      AgentInterceptor.ctorParameters = function () {
        return [{
      ...
      AgentInterceptor = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], AgentInterceptor);
      /***/
    },
    ...
    function H5iI(module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_config_panel_toggle_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./config-panel-toggle.component.html */
      "Zifb");
      /* harmony import */


      var _config_panel_toggle_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      ConfigPanelToggleComponent.ctorParameters = function () {
        return [];
      };
      ...
      ConfigPanelToggleComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function HiSN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Hv0H(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _vex_components_mega_menu_mega_menu_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! @vex/components/mega-menu/mega-menu.module */
      "C6sw");
      /* harmony import */


      var _vex_components_navigation_item_navigation_item_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! @vex/components/navigation-item/navigation-item.module */
      "5PI4");
      /* harmony import */


      var _vex_components_toolbar_search_toolbar_search_module__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! @vex/components/toolbar-search/toolbar-search.module */
      "gDAd");
      /* harmony import */
      ...
      var _vex_layout_navigation_navigation_module__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! @vex/layout/navigation/navigation.module */
      "ycnu");
      /* harmony import */
      ...
      var _projects_services_project_data_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! @projects/services/project-data.service */
      "oyjd");
      /* harmony import */


      var _components_toolbar_mock_url_toolbar_mock_url_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
      /*! ./components/toolbar-mock-url/toolbar-mock-url.component */
      "O4Sr");
      /* harmony import */


      var _components_toolbar_proxy_settings_toolbar_proxy_settings_module__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
      /*! ./components/toolbar-proxy-settings/toolbar-proxy-settings.module */
      "whvR");
      /* harmony import */


      var _components_toolbar_user_toolbar_user_module__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      /*! ./components/toolbar-user/toolbar-user.module */
      "UY+R");
      /* harmony import */


      var _toolbar_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
      /*! ./toolbar.component */
      "cd7D");
      ...
      ToolbarModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_7__["MatRippleModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_8__["MatDialogModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_9__["MatDividerModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_10__["MatFormFieldModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_11__["MatIconModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_12__["MatInputModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_13__["MatMenuModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_14__["MatSelectModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_15__["MatSnackBarModule"], _vex_directives_container_container_module__WEBPACK_IMPORTED_MODULE_19__["ContainerModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_21__["IconModule"], _vex_components_mega_menu_mega_menu_module__WEBPACK_IMPORTED_MODULE_16__["MegaMenuModule"], _vex_layout_navigation_navigation_module__WEBPACK_IMPORTED_MODULE_20__["NavigationModule"], _vex_components_navigation_item_navigation_item_module__WEBPACK_IMPORTED_MODULE_17__["NavigationItemModule"], _components_toolbar_proxy_settings_toolbar_proxy_settings_module__WEBPACK_IMPORTED_MODULE_24__["ToolbarProxySettingsModule"], _components_toolbar_user_toolbar_user_module__WEBPACK_IMPORTED_MODULE_25__["ToolbarUserModule"], _vex_components_toolbar_search_toolbar_search_module__WEBPACK_IMPORTED_MODULE_18__["ToolbarSearchModule"]],
    ...
    /***/
    function KD9O(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function L3CV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Li0u(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function Li13(module, __webpack_exports__, __webpack_require__) {
      ...
      var _progress_bar_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      ProgressBarModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
    ...
    /***/
    function M0zT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var Response = /*#__PURE__*/function (_request_component__W2) {
        _inherits(Response, _request_component__W2);
        ...
        function Response(response) {
          ...
          _this16 = _super2.call(this, 5, response.id);
          _this16.text = response.text;

          if (response.is_json !== undefined) {
            _this16.isJson = response.is_json;
          } else {
            _this16.isJson = true;
          }
    ...
    /***/
    function NJG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ToolbarProxySettingsComponent", function () {
        return ToolbarProxySettingsComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_toolbar_proxy_settings_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./toolbar-proxy-settings.component.html */
      "z6XH");
      /* harmony import */


      var _toolbar_proxy_settings_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./toolbar-proxy-settings.component.scss */
      "UZWc");
      /* harmony import */
      ...
      var _iconify_icons_ic_twotone_arrow_drop_down__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-arrow-drop-down */
      "LgSP");
      /* harmony import */


      var _iconify_icons_ic_twotone_arrow_drop_down__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_arrow_drop_down__WEBPACK_IMPORTED_MODULE_7__);
      /* harmony import */


      var _iconify_icons_ic_twotone_file_copy__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-file-copy */
      "L5jV");
      /* harmony import */


      var _iconify_icons_ic_twotone_file_copy__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_file_copy__WEBPACK_IMPORTED_MODULE_8__);
      /* harmony import */


      var _iconify_icons_ic_twotone_play_arrow__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-play-arrow */
      "UfLF");
      /* harmony import */


      var _iconify_icons_ic_twotone_play_arrow__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_play_arrow__WEBPACK_IMPORTED_MODULE_9__);
      /* harmony import */


      var _iconify_icons_ic_twotone_settings__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-settings */
      "hF2C");
      /* harmony import */


      var _iconify_icons_ic_twotone_settings__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_settings__WEBPACK_IMPORTED_MODULE_10__);
      /* harmony import */


      var _iconify_icons_ic_twotone_stop__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-stop */
      "KhN+");
      /* harmony import */


      var _iconify_icons_ic_twotone_stop__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_stop__WEBPACK_IMPORTED_MODULE_11__);
      /* harmony import */


      var _core_http__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! @core/http */
      "vAmI");
      /* harmony import */


      var _core_http_agent_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! @core/http/agent.service */
      "/JUU");
      /* harmony import */
      ...
      var _components_toolbar_mock_settings_toolbar_mock_settings_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./components/toolbar-mock-settings/toolbar-mock-settings.component */
      "FYDM");
      /* harmony import */


      var _components_toolbar_record_settings_toolbar_record_settings_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./components/toolbar-record-settings/toolbar-record-settings.component */
      "f/93");

      var ToolbarProxySettingsComponent = /*#__PURE__*/function () {
        function ToolbarProxySettingsComponent(cd, clipboard, dialog, agentService, projectResource, scenarioResource, snackbar) {
          _classCallCheck(this, ToolbarProxySettingsComponent);
        ...
        _createClass(ToolbarProxySettingsComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.showModes();
          } // API Access
          ...
          key: "showModes",
          value: function showModes() {
            var _this17 = this;

            this.agentService.showConfigsModes().subscribe(function (res) {
              _this17.modes = res;

              _this17.showProject();

              _this17.showScenario();
            });
          }
        }, {
          key: "showProject",
          value: function showProject() {
            ...
            var activeMode = this.modes.active;
            var details = this.modes.details[activeMode];

            if (!details.project_id) {
              this.activeScenario = null;
              this.cd.markForCheck();
            } else {
              this.projectResource.show(details.project_id).subscribe(function (res) {
                _this18.activeProject = new _data_schema__WEBPACK_IMPORTED_MODULE_14__["Project"](res);
          ...
          value: function showScenario() {
            ...
            if (!details.scenario_id) {
              ...
              this.scenarioResource.show(details.scenario_id).subscribe(function (res) {
                _this19.activeScenario = new _data_schema__WEBPACK_IMPORTED_MODULE_14__["Scenario"](res);
          ...
          key: "showRecordSettings",
          value: function showRecordSettings() {
            var _this20 = this;

            this.dropdownOpen = true;
            this.cd.markForCheck();
            var popoverRef = this.dialog.open(_components_toolbar_record_settings_toolbar_record_settings_component__WEBPACK_IMPORTED_MODULE_17__["ToolbarRecordSettingsComponent"], {
              width: '600px'
            });
            var onProjectChangeSub = popoverRef.componentInstance.onProjectChange.subscribe(function (project) {
              _this20.activeProject = project;

              _this20.cd.markForCheck();
            });
            var onScenarioChangeSub = popoverRef.componentInstance.onScenarioChange.subscribe(function (scenario) {
              _this20.activeScenario = scenario;

              _this20.cd.markForCheck();
            });
            popoverRef.afterClosed().subscribe(function () {
              _this20.dropdownOpen = false;
          ...
          key: "showMockSettings",
          value: function showMockSettings() {
            var _this21 = this;

            this.dropdownOpen = true;
            this.cd.markForCheck();
            var popoverRef = this.dialog.open(_components_toolbar_mock_settings_toolbar_mock_settings_component__WEBPACK_IMPORTED_MODULE_16__["ToolbarMockSettingsComponent"], {
              width: '600px'
            });
            var onProjectChangeSub = popoverRef.componentInstance.onProjectChange.subscribe(function (project) {
              _this21.activeProject = project;
            });
            var onScenarioChangeSub = popoverRef.componentInstance.onScenarioChange.subscribe(function (scenario) {
              _this21.activeScenario = scenario;
            });
            popoverRef.afterClosed().subscribe(function () {
              _this21.dropdownOpen = false;
              onProjectChangeSub.unsubscribe();
              onScenarioChangeSub.unsubscribe();
          ...
          key: "setMode",
          value: function setMode(modeVal) {
            var _this22 = this;
            ...
            this.agentService.updateConfig(body).subscribe(function (res) {
              _this22.modes.active = modeVal;
              _this22.modes.enabled = false;
          ...
          value: function toggleEnabled() {
            ...
            this.agentService.updateConfig(body).subscribe(function (res) {
              _this23.modes.enabled = !_this23.modes.enabled;
      ...
      ToolbarProxySettingsComponent.ctorParameters = function () {
        return [{
      ...
      ToolbarProxySettingsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    function NEAy(module, __webpack_exports__, __webpack_require__) {
      ...
      var _animations_popover_animation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../animations/popover.animation */
      "2e3Z");
      /* harmony import */


      var _popover_ref__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./popover-ref */
      "QaI9");
    ...
    function NUQi(module, __webpack_exports__, __webpack_require__) {
      ...
      var angular_token__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! angular-token */
      "hU4o");
      ...
      var AuthGuard = /*#__PURE__*/function () {
        ...
        _createClass(AuthGuard, [{
          ...
          value: function canActivate(next, state) {
            ...
            this.router.navigate(['/login']); // Can save redirect url so after authing we can move them back to the page they requested
    ...
    function Neo8(module, __webpack_exports__, __webpack_require__) {
      ...
      var _core_utils_http_error_handler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! @core/utils/http-error-handler */
      "87D3");
        ...
        _createClass(HttpErrorInterceptor, [{
          ...
          value: function intercept(request, next) {
            ...
            return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
              return _this24.errorHandler.handleError(err);
            }));
          }
        }]);
    ...
    /***/
    function O4Sr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ToolbarMockUrlComponent", function () {
        return ToolbarMockUrlComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_toolbar_mock_url_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./toolbar-mock-url.component.html */
      "nvf/");
      /* harmony import */


      var _toolbar_mock_url_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./toolbar-mock-url.component.scss */
      "AKSP");
      /* harmony import */
      ...
      var _iconify_icons_ic_twotone_file_copy__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-file-copy */
      "L5jV");
      /* harmony import */


      var _iconify_icons_ic_twotone_file_copy__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_file_copy__WEBPACK_IMPORTED_MODULE_11__);
      /* harmony import */


      var _core_http_scenario_resource_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! @core/http/scenario-resource.service */
      "3Ncz");
      /* harmony import */
      ...
      var _projects_services_project_data_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! @projects/services/project-data.service */
      "oyjd");
      /* harmony import */


      var _projects_services_projects_data_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! @projects/services/projects-data.service */
      "mbNh");

      var ToolbarMockUrlComponent = /*#__PURE__*/function () {
        function ToolbarMockUrlComponent(clipboard, dialogRef, fb, projectDataService, scenarioResource, snackbar, projectsDataService) {
          _classCallCheck(this, ToolbarMockUrlComponent);
        ...
        _createClass(ToolbarMockUrlComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            // Initialize form
            this.form = this.fb.group({
          ...
          value: function getScenarios(projectId) {
            ...
            return this.scenarioResource.index({
              ...
              _this25.scenarios = res.list.map(function (s) {
          ...
          value: function copyUrl($event) {
            var url = this.form.value.mockUrl;
          ...
          key: "selectScenario",
          value: function selectScenario($event) {
            var scenario = $event.value;
            this.form.patchValue({
          ...
          value: function handleProjectSelect(project) {
            if (!project) {
              return;
            }
          ...
          key: "initializeProjects$",
          value: function initializeProjects$() {
            if (!this.projectsDataService.projects) {
          ...
          key: "initializeScenarios",
          value: function initializeScenarios() {
            if (this.project) {
              this.getScenarios(this.project.id).subscribe(function (res) {});
            }
          }
          ...
          key: "compareProjects",
          value: function compareProjects(o1, o2) {
      ...
      ToolbarMockUrlComponent.ctorParameters = function () {
        return [{
          type: _angular_cdk_clipboard__WEBPACK_IMPORTED_MODULE_3__["Clipboard"]
        }, {
      ...
      ToolbarMockUrlComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    /***/
    function O7ya(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _core_http_user_resource_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! @core/http/user-resource.service */
      "9IlP");
      /* harmony import */


      var _data_schema_user__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @data/schema/user */
      "/8CK");
      ...
      var UserDataService = /*#__PURE__*/function () {
        ...
        _createClass(UserDataService, [{
          ...
          value: function get() {
            ...
            this.userResource.profile().subscribe(function (res) {
              _this26.set(new _data_schema_user__WEBPACK_IMPORTED_MODULE_4__["User"](res));
            });
            return this.user$;
          }
        }, {
    ...
    /***/
    function OZ7D(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var UrlBuilder = /*#__PURE__*/function () {
        ...
        _createClass(UrlBuilder, [{
          ...
          key: "search",
          value: function search(parameter, value) {
            this.glue();
    ...
    /***/
    function P9CE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AliasValue", function () {
        return AliasValue;
      });

      var AliasValue = function AliasValue(aliasValue) {
        _classCallCheck(this, AliasValue);
    ...
    /***/
    function PC2b(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var PopoverRef = /*#__PURE__*/function () {
        function PopoverRef(overlay, content, data) {
          ...
          overlay.backdropClick().subscribe(function () {
            _this27._close('backdropClick', null);
          });
        }
    ...
    /***/
    function RdP6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OmniauthCallbacksApi", function () {
        return OmniauthCallbacksApi;
      });
      /* harmony import */
      ...
      var OmniauthCallbacksApi = /*#__PURE__*/function () {
        function OmniauthCallbacksApi(httpService) {
          _classCallCheck(this, OmniauthCallbacksApi);

          this.httpService = httpService;
          this.ENDPOINT = 'omniauth';
        }

        _createClass(OmniauthCallbacksApi, [{
          key: "google",
          value: function google(params) {
            var url = this.httpService.buildUrl([this.ENDPOINT, 'google_oauth2', 'callback']);
      ...
      OmniauthCallbacksApi.ctorParameters = function () {
        return [{
          type: _http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"]
        }];
      };

      OmniauthCallbacksApi = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    /***/
    function SEeg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Sxwf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ScenarioPriorities", function () {
        return ScenarioPriorities;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "ScenarioPriorityData", function () {
        return ScenarioPriorityData;
      });

      var Scenario = function Scenario(scenario) {
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var luxon__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! luxon */
      "ExVU");
      /* harmony import */


      var luxon__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(luxon__WEBPACK_IMPORTED_MODULE_8__);
      /* harmony import */
      ...
      var _iconify_icons_ic_collections__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! @iconify/icons-ic/collections */
      "nn58");
      /* harmony import */


      var _iconify_icons_ic_collections__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_collections__WEBPACK_IMPORTED_MODULE_10__);
      /* harmony import */


      var _iconify_icons_ic_link__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! @iconify/icons-ic/link */
      "Pi/6");
      /* harmony import */


      var _iconify_icons_ic_link__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_link__WEBPACK_IMPORTED_MODULE_11__);
      /* harmony import */


      var _iconify_icons_ic_list__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! @iconify/icons-ic/list */
      "mb2K");
      /* harmony import */


      var _iconify_icons_ic_list__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_list__WEBPACK_IMPORTED_MODULE_12__);
      /* harmony import */


      var _iconify_icons_ic_settings__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! @iconify/icons-ic/settings */
      "Ijxr");
      /* harmony import */


      var _iconify_icons_ic_settings__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_settings__WEBPACK_IMPORTED_MODULE_13__);
      /* harmony import */


      var _iconify_icons_ic_twotone_layers__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-layers */
      "7nbV");
      /* harmony import */


      var _iconify_icons_ic_twotone_layers__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_layers__WEBPACK_IMPORTED_MODULE_14__);
      /* harmony import */


      var _vex_services_config_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! @vex/services/config.service */
      "lC2v");
      /* harmony import */


      var _vex_services_layout_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! @vex/services/layout.service */
      "CtTw");
      /* harmony import */


      var _vex_services_navigation_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! @vex/services/navigation.service */
      "0vMP");
      /* harmony import */


      var _vex_services_splash_screen_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! @vex/services/splash-screen.service */
      "AQ4D");
      /* harmony import */


      var _vex_services_style_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! @vex/services/style.service */
      "Z+W5");
      /* harmony import */


      var _layout_services_layout_config_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! @layout/services/layout-config.service */
      "U9Lm");
      /* harmony import */


      var _projects_services_project_data_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! @projects/services/project-data.service */
      "oyjd");

      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(document, localeId, configService, layoutService, layoutConfigService, navigationService, platform, projectDataService, renderer, route, router, splashScreenService, styleService) {
          var _this28 = this;
          ...
          this.configService.setConfig('vex-layout-zeus'); // this.styleService.setStyle('light' as Style);
          // Define navbar
          ...
          this.navigationService.items = [{
            ...
            route: '/requests',
            isVisible: function isVisible() {
              return _this28.isProject();
            },
            handleClick: function handleClick() {
              _this28.showPath('/requests');
            },
          ...
          this.route.queryParamMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["filter"])(function (queryParamMap) {
            return queryParamMap.has('rtl') && Object(_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_3__["coerceBooleanProperty"])(queryParamMap.get('rtl'));
          })).subscribe(function (queryParamMap) {
            _this28.document.body.dir = 'rtl';

            _this28.configService.updateConfig({
              rtl: true
            });
          });
          this.route.queryParamMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["filter"])(function (queryParamMap) {
            ...
            return _this28.configService.setConfig(queryParamMap.get('layout'));
          });
          this.route.queryParamMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["filter"])(function (queryParamMap) {
            return queryParamMap.has('style');
          })).subscribe(function (queryParamMap) {
            return _this28.styleService.setStyle(queryParamMap.get('style'));
          });
        } // constructor
        // View Access
        ...
        _createClass(AppComponent, [{
          ...
          value: function showPath(path) {
            var project = this.projectDataService.project || {};
            var snapshot = this.route.snapshot;
            var projectId = snapshot.queryParams.project_id || project.id;
          ...
          key: "showSettingsPath",
          value: function showSettingsPath() {
            var project = this.projectDataService.project || {};
            var snapshot = this.route.snapshot;
            var projectId = snapshot.queryParams.project_id || project.id;
            var path = "/projects/".concat(projectId, "/settings");
            this.router.navigate([path]);
          } // Helpers

        }, {
          key: "getResolvedPath",
          value: function getResolvedPath(route) {
      ...
      AppComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["Component"])({
        selector: 'vex-root',
    ...
    function TQy(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "EndpointResource", function () {
      ...
      var EndpointResource = /*#__PURE__*/function () {
        function EndpointResource(restApi) {
          _classCallCheck(this, EndpointResource);

          this.restApi = restApi;
          this.ENDPOINT = 'endpoints';
        }

        _createClass(EndpointResource, [{
          key: "index",
          value: function index(queryParams) {
            return this.restApi.index([this.ENDPOINT], queryParams);
          }
      ...
      EndpointResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      EndpointResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], EndpointResource);
      /***/
    },
    ...
    /***/
    function TE1C(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PlanResource", function () {
        return PlanResource;
      });
      /* harmony import */
      ...
      var PlanResource = /*#__PURE__*/function () {
        function PlanResource(restApi) {
          _classCallCheck(this, PlanResource);

          this.restApi = restApi;
          this.ENDPOINT = 'plans';
        }

        _createClass(PlanResource, [{
          key: "index",
          value: function index(queryParams) {
            return this.restApi.index([this.ENDPOINT], queryParams);
          }
      ...
      PlanResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      PlanResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], PlanResource);
      /***/
    },
    ...
    /***/
    function TphN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function U9Lm(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "LayoutConfigService", function () {
      ...
      var _projects_services_project_data_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! @projects/services/project-data.service */
      "oyjd");

      var LayoutConfigService = /*#__PURE__*/function () {
        function LayoutConfigService(configService, projectDataService, route, styleService, tokenService) {
          _classCallCheck(this, LayoutConfigService);
        ...
        _createClass(LayoutConfigService, [{
          key: "setIkaros",
          value: function setIkaros() {
            this.configService.setConfig('vex-layout-ikaros'); // this.styleService.setStyle('default' as Style);
          }
        }, {
          key: "setZeus",
          value: function setZeus() {
      ...
      LayoutConfigService.ctorParameters = function () {
        return [{
      ...
      LayoutConfigService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], LayoutConfigService);
      /***/
    },
    ...
    /***/
    function UYR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _vex_components_popover_popover_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var _vex_pipes_relative_date_time_relative_date_time_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! @vex/pipes/relative-date-time/relative-date-time.module */
      "h4uD");
      /* harmony import */


      var _toolbar_user_dropdown_toolbar_user_dropdown_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./toolbar-user-dropdown/toolbar-user-dropdown.component */
      "dGqQ");
      /* harmony import */


      var _toolbar_user_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      ...
      ToolbarUserModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_5__["MatRippleModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_7__["MatMenuModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _vex_pipes_relative_date_time_relative_date_time_module__WEBPACK_IMPORTED_MODULE_13__["RelativeDateTimeModule"], _angular_router__WEBPACK_IMPORTED_MODULE_9__["RouterModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_8__["MatTooltipModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_10__["IconModule"], _vex_pipes_color_color_fade_module__WEBPACK_IMPORTED_MODULE_12__["ColorFadeModule"], _vex_components_popover_popover_module__WEBPACK_IMPORTED_MODULE_11__["PopoverModule"]],
    ...
    /***/
    function UZWc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function V99k(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _alias_value__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./alias-value */
      "P9CE");
      ...
      __webpack_require__.d(__webpack_exports__, "AliasValue", function () {
        return _alias_value__WEBPACK_IMPORTED_MODULE_0__["AliasValue"];
      });
      /* harmony import */


      var _alias__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./alias */
      "tpJP");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "Alias", function () {
        return _alias__WEBPACK_IMPORTED_MODULE_1__["Alias"];
      });
      /* harmony import */


      var _body_param__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./body-param */
      "Y7fp");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "BodyParam", function () {
        return _body_param__WEBPACK_IMPORTED_MODULE_2__["BodyParam"];
      });
      /* harmony import */


      var _endpoint__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./endpoint */
      "jBLc");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "Endpoint", function () {
        return _endpoint__WEBPACK_IMPORTED_MODULE_3__["Endpoint"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "EndpointCategories", function () {
        return _endpoint__WEBPACK_IMPORTED_MODULE_3__["EndpointCategories"];
      });
      /* harmony import */


      var _header__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./header */
      "rpPS");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "Header", function () {
        return _header__WEBPACK_IMPORTED_MODULE_4__["Header"];
      });
      /* harmony import */


      var _organizations_user__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./organizations-user */
      "FKbl");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "OrganizationsUser", function () {
        return _organizations_user__WEBPACK_IMPORTED_MODULE_5__["OrganizationsUser"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "OrganizationsUserRoles", function () {
        return _organizations_user__WEBPACK_IMPORTED_MODULE_5__["OrganizationsUserRoles"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "OrganizationsUserRoleTitles", function () {
        return _organizations_user__WEBPACK_IMPORTED_MODULE_5__["OrganizationsUserRoleTitles"];
      });
      /* harmony import */


      var _organization__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./organization */
      "7v+O");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "Organization", function () {
        return _organization__WEBPACK_IMPORTED_MODULE_6__["Organization"];
      });
      /* harmony import */


      var _path_segment__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./path-segment */
      "+fow");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "PathSegment", function () {
        return _path_segment__WEBPACK_IMPORTED_MODULE_7__["PathSegment"];
      });
      /* harmony import */


      var _project__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./project */
      "2RYP");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "Project", function () {
        return _project__WEBPACK_IMPORTED_MODULE_8__["Project"];
      });
      /* harmony import */


      var _query_param__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./query-param */
      "u7xO");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "QueryParam", function () {
        return _query_param__WEBPACK_IMPORTED_MODULE_9__["QueryParam"];
      });
      /* harmony import */


      var _request_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./request-component */
      "2bXN");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "RequestComponent", function () {
        return _request_component__WEBPACK_IMPORTED_MODULE_10__["RequestComponent"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "RequestComponentType", function () {
        return _request_component__WEBPACK_IMPORTED_MODULE_10__["RequestComponentType"];
      });
      /* harmony import */


      var _request__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./request */
      "WYQo");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "Request", function () {
        return _request__WEBPACK_IMPORTED_MODULE_11__["Request"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "RequestPriorities", function () {
        return _request__WEBPACK_IMPORTED_MODULE_11__["RequestPriorities"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "RequestPriorityData", function () {
        return _request__WEBPACK_IMPORTED_MODULE_11__["RequestPriorityData"];
      });
      /* harmony import */


      var _response__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./response */
      "M0zT");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "Response", function () {
        return _response__WEBPACK_IMPORTED_MODULE_12__["Response"];
      });
      /* harmony import */


      var _response_header__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./response-header */
      "j+4c");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "ResponseHeader", function () {
        return _response_header__WEBPACK_IMPORTED_MODULE_13__["ResponseHeader"];
      });
      /* harmony import */


      var _scenario__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./scenario */
      "Sxwf");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "Scenario", function () {
        return _scenario__WEBPACK_IMPORTED_MODULE_14__["Scenario"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "ScenarioPriorities", function () {
        return _scenario__WEBPACK_IMPORTED_MODULE_14__["ScenarioPriorities"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "ScenarioPriorityData", function () {
        return _scenario__WEBPACK_IMPORTED_MODULE_14__["ScenarioPriorityData"];
      });
      /* harmony import */


      var _user__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./user */
      "/8CK");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "User", function () {
        return _user__WEBPACK_IMPORTED_MODULE_15__["User"];
      });
      /* harmony import */


      var _plan__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./plan */
      "L3CV");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "Plan", function () {
        return _plan__WEBPACK_IMPORTED_MODULE_16__["Plan"];
      });
      /* harmony import */


      var _subscription__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./subscription */
      "8IoH");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "Subscription", function () {
        return _subscription__WEBPACK_IMPORTED_MODULE_17__["Subscription"];
      });
      /* harmony import */


      var _projects_user__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ./projects-user */
      "D9MS");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "ProjectsUser", function () {
        return _projects_user__WEBPACK_IMPORTED_MODULE_18__["ProjectsUser"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "ProjectsUserRoles", function () {
        return _projects_user__WEBPACK_IMPORTED_MODULE_18__["ProjectsUserRoles"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "ProjectsUserRoleTitles", function () {
        return _projects_user__WEBPACK_IMPORTED_MODULE_18__["ProjectsUserRoleTitles"];
      });
      /* harmony import */


      var _payment_method__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! ./payment-method */
      "vuK5");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "PaymentMethod", function () {
        return _payment_method__WEBPACK_IMPORTED_MODULE_19__["PaymentMethod"];
      });
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "PaymentMethodCard", function () {
        return _payment_method__WEBPACK_IMPORTED_MODULE_19__["PaymentMethodCard"];
      });
      /***/
    ...
    function W9UW(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_scrollbar_scrollbar_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../components/scrollbar/scrollbar.module */
      "XVi8");
      /* harmony import */


      var _components_sidenav_item_sidenav_item_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../../components/sidenav-item/sidenav-item.module */
      "YGXf");
      /* harmony import */


      var _sidenav_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./sidenav.component */
      "7JzS");
      ...
      SidenavModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_sidenav_component__WEBPACK_IMPORTED_MODULE_10__["SidenavComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_6__["MatToolbarModule"], _components_sidenav_item_sidenav_item_module__WEBPACK_IMPORTED_MODULE_9__["SidenavItemModule"], _components_scrollbar_scrollbar_module__WEBPACK_IMPORTED_MODULE_8__["ScrollbarModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIconModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_7__["IconModule"]],
    ...
    /***/
    function WYQo(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function WYjc(module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_progress_bar_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./progress-bar.component.html */
      "KD9O");
      /* harmony import */


      var _progress_bar_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    /***/
    function Wbda(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "HeaderResource", function () {
      ...
      var HeaderResource = /*#__PURE__*/function () {
        function HeaderResource(restApi) {
          _classCallCheck(this, HeaderResource);
      ...
      HeaderResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      HeaderResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], HeaderResource);
      /***/
    },
    ...
    /***/
    function XTWy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ProjectsUserResource", function () {
      ...
      var ProjectsUserResource = /*#__PURE__*/function () {
        function ProjectsUserResource(restApi) {
          _classCallCheck(this, ProjectsUserResource);
      ...
      ProjectsUserResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      ProjectsUserResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    function XVi8(module, __webpack_exports__, __webpack_require__) {
      ...
      ScrollbarModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
    ...
    /***/
    function XXSj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Xuwo(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Y7fp(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var BodyParam = /*#__PURE__*/function (_request_component__W3) {
        _inherits(BodyParam, _request_component__W3);

        var _super3 = _createSuper(BodyParam);

        function BodyParam(bodyParam) {
          var _this29;

          _classCallCheck(this, BodyParam);

          _this29 = _super3.call(this, 4, bodyParam.id, bodyParam.alias);
          _this29.name = bodyParam.name;
          _this29.value = bodyParam.value;
          _this29.aliasName = bodyParam.alias_name;
          _this29.isRequired = bodyParam.is_required;
          return _this29;
        }
    ...
    /***/
    function YCZM(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OrganizationsUserResource", function () {
        return OrganizationsUserResource;
      });
      /* harmony import */
      ...
      var OrganizationsUserResource = /*#__PURE__*/function () {
        function OrganizationsUserResource(restApi) {
          _classCallCheck(this, OrganizationsUserResource);
      ...
      OrganizationsUserResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      OrganizationsUserResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    /***/
    function YGXf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _sidenav_item_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      SidenavItemModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_sidenav_item_component__WEBPACK_IMPORTED_MODULE_8__["SidenavItemComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIconModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_4__["MatRippleModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_7__["IconModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"]],
    ...
    /***/
    function YUAm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _iconify_icons_ic_twotone_shopping_basket__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-shopping-basket */
      "RM6X");
      /* harmony import */


      var _iconify_icons_ic_twotone_shopping_basket__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_shopping_basket__WEBPACK_IMPORTED_MODULE_4__);
    ...
    /***/
    function YiRj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Ys2n(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function ZW5(module, __webpack_exports__, __webpack_require__) {
      ...
      var StyleService = /*#__PURE__*/function () {
        function StyleService(document) {
          ...
          this.style$.pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_3__["untilDestroyed"])(this)).subscribe(function (style) {
            return _this30._updateStyle(style);
          });
        }
      ...
      StyleService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
      })], StyleService);
      /***/
    },
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var angular_token__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! angular-token */
      "hU4o");
      /* harmony import */
      ...
      var _vex_vex_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! @vex/vex.module */
      "iB7b");
      /* harmony import */
      ...
      var _core_interceptors_agent_interceptor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! @core/interceptors/agent.interceptor */
      "Gg42");
      /* harmony import */


      var _core_interceptors_http_error_interceptor__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var _layout_custom_layout_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! @layout/custom-layout.module */
      "71PN");
      /* harmony import */
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [// Standard
        _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"], // Vex
        _vex_vex_module__WEBPACK_IMPORTED_MODULE_8__["VexModule"], // Third Party
        ...
        }), angularx_social_login__WEBPACK_IMPORTED_MODULE_6__["SocialLoginModule"], ngx_stripe__WEBPACK_IMPORTED_MODULE_7__["NgxStripeModule"].forRoot(_environments_environment__WEBPACK_IMPORTED_MODULE_12__["environment"].stripeKey), // Application
        _core_core_module__WEBPACK_IMPORTED_MODULE_9__["CoreModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_14__["AppRoutingModule"], _layout_custom_layout_module__WEBPACK_IMPORTED_MODULE_13__["CustomLayoutModule"]],
        providers: [{
    ...
    /***/
    function Zifb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function a3ZD(module, __webpack_exports__, __webpack_require__) {
      ...
      var ContainerDirective = /*#__PURE__*/function () {
        function ContainerDirective(configService, cd) {
          ...
          this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (config) {
            return config.boxed;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_2__["untilDestroyed"])(this)).subscribe(function (boxed) {
            _this31.enabled = boxed;

            _this31.cd.markForCheck();
          });
        }
      ...
      ContainerDirective = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
    ...
    /***/
    function bJeg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function c7Bs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function cD1t(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_toolbar_user_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _vex_components_popover_popover_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @vex/components/popover/popover.service */
      "kYjG");
      /* harmony import */


      var _vex_utils_tailwindcss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! @vex/utils/tailwindcss */
      "XXSj");
      /* harmony import */


      var _iconify_icons_ic_twotone_person__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-person */
      "KaaH");
      /* harmony import */


      var _iconify_icons_ic_twotone_person__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_person__WEBPACK_IMPORTED_MODULE_6__);
      /* harmony import */
      ...
      var _toolbar_user_dropdown_toolbar_user_dropdown_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./toolbar-user-dropdown/toolbar-user-dropdown.component */
      "dGqQ");

      var ToolbarUserComponent = /*#__PURE__*/function () {
        function ToolbarUserComponent(cd, popover, userData, router) {
      ...
      ToolbarUserComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    /***/
    function cFcm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function cGA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function cd7D(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _toolbar_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _iconify_icons_emojione_flag_for_flag_germany__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! @iconify/icons-emojione/flag-for-flag-germany */
      "t6uZ");
      /* harmony import */


      var _iconify_icons_emojione_flag_for_flag_germany__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_emojione_flag_for_flag_germany__WEBPACK_IMPORTED_MODULE_6__);
      /* harmony import */


      var _iconify_icons_emojione_flag_for_flag_united_states__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! @iconify/icons-emojione/flag-for-flag-united-states */
      "6m+4");
      /* harmony import */


      var _iconify_icons_emojione_flag_for_flag_united_states__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_emojione_flag_for_flag_united_states__WEBPACK_IMPORTED_MODULE_7__);
      /* harmony import */


      var _iconify_icons_ic_twotone_arrow_drop_down__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-arrow-drop-down */
      "LgSP");
      /* harmony import */


      var _iconify_icons_ic_twotone_arrow_drop_down__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_arrow_drop_down__WEBPACK_IMPORTED_MODULE_8__);
      /* harmony import */
      ...
      var _iconify_icons_ic_twotone_bookmarks__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-bookmarks */
      "+1NE");
      /* harmony import */


      var _iconify_icons_ic_twotone_bookmarks__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_bookmarks__WEBPACK_IMPORTED_MODULE_12__);
      /* harmony import */
      ...
      var _iconify_icons_ic_twotone_description__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_description__WEBPACK_IMPORTED_MODULE_13__);
      /* harmony import */


      var _iconify_icons_ic_twotone_done_all__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-done-all */
      "mEjI");
      /* harmony import */


      var _iconify_icons_ic_twotone_done_all__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_done_all__WEBPACK_IMPORTED_MODULE_14__);
      /* harmony import */


      var _iconify_icons_ic_twotone_menu__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-menu */
      "cS8l");
      /* harmony import */


      var _iconify_icons_ic_twotone_menu__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_menu__WEBPACK_IMPORTED_MODULE_15__);
      /* harmony import */


      var _iconify_icons_ic_twotone_pageview__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-pageview */
      "9Gk2");
      /* harmony import */


      var _iconify_icons_ic_twotone_pageview__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_pageview__WEBPACK_IMPORTED_MODULE_16__);
      /* harmony import */


      var _iconify_icons_ic_twotone_person_add__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-person-add */
      "+q50");
      /* harmony import */


      var _iconify_icons_ic_twotone_person_add__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_person_add__WEBPACK_IMPORTED_MODULE_17__);
      /* harmony import */


      var _iconify_icons_ic_twotone_receipt__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-receipt */
      "Ehqh");
      /* harmony import */


      var _iconify_icons_ic_twotone_receipt__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_receipt__WEBPACK_IMPORTED_MODULE_18__);
      /* harmony import */


      var _iconify_icons_ic_twotone_search__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-search */
      "sF+I");
      /* harmony import */


      var _iconify_icons_ic_twotone_search__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_search__WEBPACK_IMPORTED_MODULE_19__);
      /* harmony import */


      var _vex_components_mega_menu_mega_menu_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! @vex/components/mega-menu/mega-menu.component */
      "pXZ5");
      /* harmony import */


      var _vex_components_popover_popover_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! @vex/components/popover/popover.service */
      "kYjG");
      /* harmony import */


      var _vex_services_config_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! @vex/services/config.service */
      "lC2v");
      /* harmony import */


      var _vex_services_layout_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
      /*! @vex/services/layout.service */
      "CtTw");
      /* harmony import */


      var _vex_services_navigation_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
      /*! @vex/services/navigation.service */
      "0vMP");
      /* harmony import */


      var _layout_services_layout_config_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      /*! @layout/services/layout-config.service */
      "U9Lm");
      /* harmony import */


      var _projects_services_project_data_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
      /*! @projects/services/project-data.service */
      "oyjd");
      /* harmony import */


      var _components_toolbar_mock_url_toolbar_mock_url_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
      /*! ./components/toolbar-mock-url/toolbar-mock-url.component */
      "O4Sr");

      var ToolbarComponent = /*#__PURE__*/function () {
        function ToolbarComponent(dialog, configService, layoutService, layoutConfigService, navigationService, popoverService, projectDataService) {
        ...
        _createClass(ToolbarComponent, [{
          ...
          key: "showMockUrl",
          value: function showMockUrl() {
            var popoverRef = this.dialog.open(_components_toolbar_mock_url_toolbar_mock_url_component__WEBPACK_IMPORTED_MODULE_27__["ToolbarMockUrlComponent"], {
              width: '600px'
            });
            popoverRef.afterClosed().subscribe(function () {});
          }
    ...
    function cwwZ(module, __webpack_exports__, __webpack_require__) {
      ...
      LayoutModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_3__["MatSidenavModule"], _components_progress_bar_progress_bar_module__WEBPACK_IMPORTED_MODULE_5__["ProgressBarModule"], _components_search_search_module__WEBPACK_IMPORTED_MODULE_6__["SearchModule"]],
    ...
    /***/
    function d5u2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function dGqQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_toolbar_user_dropdown_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./toolbar-user-dropdown.component.html */
      "G605");
      /* harmony import */


      var _toolbar_user_dropdown_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _vex_components_popover_popover_ref__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! @vex/components/popover/popover-ref */
      "QaI9");
      /* harmony import */


      var _vex_utils_track_by__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! @vex/utils/track-by */
      "zK3P");
      /* harmony import */


      var _data_constants_route_constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! @data/constants/route.constants */
      "wZfh");
      /* harmony import */


      var _users_services_user_data_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! @users/services/user-data.service */
      "O7ya");
      /* harmony import */


      var _services_toolbar_user_dropdown_icons_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./services/toolbar-user-dropdown-icons.service */
      "3v0u");

      var ToolbarUserDropdownComponent = /*#__PURE__*/function () {
        function ToolbarUserDropdownComponent(icons, cd, popoverRef, router, tokenService, userData) {
        ...
        _createClass(ToolbarUserDropdownComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.user$.subscribe(function (user) {
              ...
              _this33.items = [{
                id: '1',
                icon: _this33.icons.icAccountCircle,
                label: 'My Profile',
                description: 'Personal Information',
                colorClass: 'text-teal-500',
                route: "/users/".concat(user.id, "/profile")
              }, // {
              //   id: '2',
              //   icon: icMoveToInbox,
              //   label: 'My Inbox',
              ...
              // },
              {
                ...
                id: '4',
                icon: _this33.icons.icTableChart,
                label: 'Billing Information',
                description: 'Pricing & Current Plan',
                colorClass: 'text-purple-500',
                route: "/users/".concat(user.id, "/billing")
              }];
            });
            this.statuses = [{
              id: 'online',
          ...
          value: function logout() {
            ...
            this.tokenService.signOut().subscribe(function (res) {
              _this34.popoverRef.close();

              _this34.router.navigateByUrl(_data_constants_route_constants__WEBPACK_IMPORTED_MODULE_8__["RouteConstants"].LOGIN_PAGE);
            });
          }
        }]);
      ...
      ToolbarUserDropdownComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function dO6N(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function dPIg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function f93(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ToolbarRecordSettingsComponent", function () {
        return ToolbarRecordSettingsComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_toolbar_record_settings_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./toolbar-record-settings.component.html */
      "46RW");
      /* harmony import */


      var _toolbar_record_settings_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./toolbar-record-settings.component.scss */
      "SEeg");
      /* harmony import */
      ...
      var ToolbarRecordSettingsComponent = /*#__PURE__*/function () {
        function ToolbarRecordSettingsComponent(dialogRef, fb, agentService, projectDataService, scenarioResource, userDataService, projectsDataService) {
          _classCallCheck(this, ToolbarRecordSettingsComponent);
        ...
        _createClass(ToolbarRecordSettingsComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this35 = this;
            ...
            this.initializePolicies();
            this.initializeConfig().subscribe(function (res) {
              _this35.initializeProjects$(_this35.config);

              _this35.initializeProject(_this35.config);

              _this35.initializeScenarios(_this35.config);
            });
          } // API Access
          ...
          key: "clearServiceUrl",
          value: function clearServiceUrl() {
            this.form.patchValue({
              serviceUrl: null
            });
          }
          ...
          value: function initializePolicies() {
            ...
            this.agentService.showConfigsPolicies().subscribe(function (res) {
              _this38.policies = Object.values(res);
            });
          }
        }, {
          key: "initializeConfig",
          value: function initializeConfig() {
            ...
            return this.agentService.showConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (res) {
              ...
              if (config) {
                _this39.config = new _schema_agent_config__WEBPACK_IMPORTED_MODULE_14__["AgentConfig"](config);

                _this39.form.patchValue({
                  recordPolicy: _this39.config.mode.record.policy,
                  serviceUrl: _this39.config.mode.record.serviceUrl
                });

                _this39.config.mode.record.includePatterns.forEach(function (pattern) {
                  _this39.addIncludePattern(pattern);
                });

                _this39.config.mode.record.excludePatterns.forEach(function (pattern) {
                  _this39.addExcludePattern(pattern);
                });
              }
            }));
          } // Set projects$ observable
          ...
          value: function initializeScenarios(config) {
            ...
            if (this.project) {
              this.getScenarios(this.project.id).subscribe(function (res) {
                _this41.scenarios.some(function (scenario) {
      ...
      ToolbarRecordSettingsComponent.ctorParameters = function () {
        return [{
          type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__["MatDialogRef"]
        }, {
          type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"]
      ...
      ToolbarRecordSettingsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function fQJz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function fzgV(module, __webpack_exports__, __webpack_require__) {
      ...
      RelativeDateTimePipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
    ...
    /***/
    function gDAd(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _toolbar_search_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    /***/
    function gHic(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _url_builder__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./url-builder */
      "OZ7D");
      ...
      var HttpService = /*#__PURE__*/function () {
        ...
        _createClass(HttpService, [{
          key: "mergeQueryParams",
          value: function mergeQueryParams(url, params) {
            var queryString = '';

            for (var key in params) {
              if (!queryString) {
                queryString = "?".concat(encodeURIComponent(key), "=").concat(encodeURIComponent(params[key]));
              } else {
                queryString += "&".concat(encodeURIComponent(key), "=").concat(encodeURIComponent(params[key]));
              }
            }
          ...
          key: "post",
          value: function post(url, postBody, options) {
          ...
          key: "put",
          value: function put(url, putData, options) {
            return this.http.put(url, putData, options);
          }
        }, {
          key: "upload",
          value: function upload(url, file, options) {
          ...
          key: "buildUrl",
          value: function buildUrl(pathComponents, queryParams) {
            var urlBuilder = new _url_builder__WEBPACK_IMPORTED_MODULE_4__["UrlBuilder"]();
            urlBuilder.withPath(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl);

            var _iterator = _createForOfIteratorHelper(pathComponents),
                _step;
    ...
    function gXZ(module, __webpack_exports__, __webpack_require__) {
      ...
      PopoverModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
    ...
    function h4uD(module, __webpack_exports__, __webpack_require__) {
      ...
      RelativeDateTimeModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
    ...
    /***/
    function hXM(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PathSegmentNameResource", function () {
        return PathSegmentNameResource;
      });
      /* harmony import */
      ...
      var PathSegmentNameResource = /*#__PURE__*/function () {
        function PathSegmentNameResource(restApi) {
          _classCallCheck(this, PathSegmentNameResource);
        ...
        _createClass(PathSegmentNameResource, [{
          key: "index",
          value: function index(endpointId, queryParams) {
            return this.restApi.index([this.ENDPOINT_ENDPOINT, endpointId, this.ENDPOINT], queryParams);
          }
      ...
      PathSegmentNameResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      PathSegmentNameResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    function iB7b(module, __webpack_exports__, __webpack_require__) {
      ...
      VexModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _layout_layout_module__WEBPACK_IMPORTED_MODULE_4__["LayoutModule"]],
        exports: [_layout_layout_module__WEBPACK_IMPORTED_MODULE_4__["LayoutModule"]],
        providers: [{
    ...
    /***/
    function iCaw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var RestApiService = /*#__PURE__*/function () {
        function RestApiService(httpService) {
        ...
        _createClass(RestApiService, [{
          key: "index",
          value: function index(pathComponents, queryParams) {
            var url = this.httpService.buildUrl(pathComponents, queryParams);
            return this.httpService.get(url);
          }
        }, {
          key: "show",
          value: function show(pathComponents, queryParams) {
            var url = this.httpService.buildUrl(pathComponents, queryParams);
            return this.httpService.get(url);
          }
        }, {
          key: "create",
          value: function create(pathComponents, body) {
            var url = this.httpService.buildUrl(pathComponents);
            return this.httpService.post(url, body);
          }
        }, {
          key: "update",
          value: function update(pathComponents, body) {
            var url = this.httpService.buildUrl(pathComponents);
            return this.httpService.put(url, body);
          }
        }, {
          key: "destroy",
          value: function destroy(pathComponents, queryParams) {
            var url = this.httpService.buildUrl(pathComponents, queryParams);
            return this.httpService["delete"](url);
          }
        }, {
          key: "path",
          value: function path(pathComponents, queryParams) {
    ...
    /***/
    function j4c(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ResponseHeader = /*#__PURE__*/function (_request_component__W4) {
        _inherits(ResponseHeader, _request_component__W4);

        var _super4 = _createSuper(ResponseHeader);

        function ResponseHeader(header) {
          var _this42;

          _classCallCheck(this, ResponseHeader);

          _this42 = _super4.call(this, 6, header.id);
          _this42.name = header.name;
          _this42.value = header.value;
          return _this42;
        }
    ...
    /***/
    function jBLc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function jXNf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_toolbar_search_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./toolbar-search.component.html */
      "D1/4");
      /* harmony import */


      var _toolbar_search_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _iconify_icons_ic_twotone_search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-search */
      "sF+I");
      /* harmony import */


      var _iconify_icons_ic_twotone_search__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_search__WEBPACK_IMPORTED_MODULE_4__);
      ...
      var ToolbarSearchComponent = /*#__PURE__*/function () {
        ...
        _createClass(ToolbarSearchComponent, [{
          ...
          value: function open() {
            ...
            this.cd.markForCheck();
            setTimeout(function () {
              _this43.input.nativeElement.focus();
            }, 100);
          }
        }, {
          key: "close",
      ...
      ToolbarSearchComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    function kYjG(module, __webpack_exports__, __webpack_require__) {
      ...
      var PopoverService = /*#__PURE__*/function () {
        ...
        _createClass(PopoverService, [{
          ...
          value: function getOverlayConfig(_ref8) {
          ...
          value: function getOverlayPosition(_ref9) {
      ...
      PopoverService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Injectable"])({
        providedIn: 'root'
      })], PopoverService);
      /***/
    },
    ...
    /***/
    function kqhm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "QueryParamResource", function () {
        return QueryParamResource;
      });
      /* harmony import */
      ...
      var QueryParamResource = /*#__PURE__*/function () {
        function QueryParamResource(restApi) {
          _classCallCheck(this, QueryParamResource);
        ...
        _createClass(QueryParamResource, [{
          key: "index",
          value: function index(requestId, queryParams) {
            if (typeof requestId === 'object') {
              queryParams = requestId;
      ...
      QueryParamResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      QueryParamResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], QueryParamResource);
      /***/
    },
    ...
    function lC2v(module, __webpack_exports__, __webpack_require__) {
      ...
      var _utils_merge_deep__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../utils/merge-deep */
      "Sl3+");
      /* harmony import */
      ...
      var _layout_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./layout.service */
      "CtTw");
      ...
      var ConfigService = /*#__PURE__*/function () {
        function ConfigService(document, layoutService) {
          ...
          this._configSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](this.configs.find(function (c) {
            return c.id === _this44.defaultConfig;
          }));
          this.config$ = this._configSubject.asObservable();
          this.config$.subscribe(function (config) {
            return _this44._updateConfig(config);
          });
        }
        ...
        _createClass(ConfigService, [{
          ...
          value: function _updateConfig(config) {
            ...
            body.classList.add(config.id); //config.sidenav.state === 'expanded' ? this.layoutService.expandSidenav() : this.layoutService.collapseSidenav();
    ...
    /***/
    function mQ6f(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _quickpanel_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      QuickpanelModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_quickpanel_component__WEBPACK_IMPORTED_MODULE_7__["QuickpanelComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_4__["MatListModule"], _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_5__["MatProgressBarModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_3__["MatRippleModule"]],
    ...
    function mbJQ(module, __webpack_exports__, __webpack_require__) {
      ...
      var _config_panel_toggle_config_panel_toggle_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./config-panel-toggle/config-panel-toggle.component */
      "H5iI");
      /* harmony import */


      var _config_panel_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      ConfigPanelModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_9__["IconModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_7__["MatRadioModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_8__["MatSlideToggleModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_5__["MatRippleModule"]],
    ...
    /***/
    function mbNh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _data_schema__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @data/schema */
      "V99k");

      var ProjectsDataService = /*#__PURE__*/function () {
        function ProjectsDataService(projectResource) {
        ...
        _createClass(ProjectsDataService, [{
          key: "fetch",
          value: function fetch(organizationId) {
            var _this45 = this;

            var queryParams = {
              organization_id: organizationId
            };
            this.projectResource.index(queryParams).subscribe(function (projects) {
              _this45.set(projects.map(function (p) {
      ...
      ProjectsDataService.ctorParameters = function () {
        return [{
          type: _core_http_project_resource_service__WEBPACK_IMPORTED_MODULE_3__["ProjectResource"]
        }];
      };

      ProjectsDataService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], ProjectsDataService);
      /***/
    },
    ...
    /***/
    function nPC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ResponseHeaderResource", function () {
      ...
      var ResponseHeaderResource = /*#__PURE__*/function () {
        function ResponseHeaderResource(restApi) {
          _classCallCheck(this, ResponseHeaderResource);
        ...
        _createClass(ResponseHeaderResource, [{
          key: "index",
          value: function index(requestId, queryParams) {
            return this.restApi.index([this.REQUEST_ENDPOINT, requestId, this.ENDPOINT], queryParams);
          }
          ...
          key: "destroy",
          value: function destroy(requestId, id) {
      ...
      ResponseHeaderResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      ResponseHeaderResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    /***/
    function nW1T(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function nmZq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AgentConfig", function () {
        return AgentConfig;
      });

      var AgentConfig = function AgentConfig(config) {
        _classCallCheck(this, AgentConfig);

        this.apiUrl = config.api_url;
        this.apiKey = config.api_key;
        var recordConfig = config.mode.record;
        var mockConfig = config.mode.mock;
        this.mode = {
    ...
    /***/
    function npeK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "BodyParamResource", function () {
        return BodyParamResource;
      });
      /* harmony import */
      ...
      var BodyParamResource = /*#__PURE__*/function () {
        function BodyParamResource(restApi) {
          _classCallCheck(this, BodyParamResource);
        ...
        _createClass(BodyParamResource, [{
          key: "index",
          value: function index(requestId, queryParams) {
            if (typeof requestId === 'object') {
              queryParams = requestId;
      ...
      BodyParamResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      BodyParamResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], BodyParamResource);
      /***/
    },
    ...
    /***/
    function nvf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function oFyy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AliasValueResource", function () {
        return AliasValueResource;
      });
      /* harmony import */
      ...
      var AliasValueResource = /*#__PURE__*/function () {
        function AliasValueResource(restApi) {
          _classCallCheck(this, AliasValueResource);

          this.restApi = restApi;
          this.ENDPOINT = 'alias_values';
        }

        _createClass(AliasValueResource, [{
          key: "index",
          value: function index(queryParams) {
            return this.restApi.index([this.ENDPOINT], queryParams);
          }
      ...
      AliasValueResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      AliasValueResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], AliasValueResource);
      /***/
    },
    ...
    /***/
    function oKEX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function og7a(module, __webpack_exports__, __webpack_require__) {
      ...
      SidebarComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    function oyjd(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProjectDataService = /*#__PURE__*/function () {
        function ProjectDataService(projectResource) {
        ...
        _createClass(ProjectDataService, [{
          ...
          value: function fetch(id) {
            ...
            this.projectResource.show(id).subscribe(function (res) {
              _this46.set(new _data_schema_project__WEBPACK_IMPORTED_MODULE_4__["Project"](res));
            });
          }
        }, {
          key: "get",
      ...
      ProjectDataService.ctorParameters = function () {
        return [{
          type: _core_http_project_resource_service__WEBPACK_IMPORTED_MODULE_3__["ProjectResource"]
        }];
      };

      ProjectDataService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], ProjectDataService);
      /***/
    },
    ...
    /***/
    function pBFY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_quickpanel_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./quickpanel.component.html */
      "rTLG");
      /* harmony import */


      var _quickpanel_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      QuickpanelComponent.ctorParameters = function () {
        return [];
      };

      QuickpanelComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    function pKmL(module, __webpack_exports__, __webpack_require__) {
      ...
      var _core_utils_http_error_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @core/utils/http-error-handler */
      "87D3");
      ...
      CoreModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [_core_utils_http_error_handler__WEBPACK_IMPORTED_MODULE_4__["HttpErrorHandler"]]
      })], CoreModule);
      /***/
    },
    ...
    function pXZ5(module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_mega_menu_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _iconify_icons_ic_twotone_assessment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-assessment */
      "6X9H");
      /* harmony import */


      var _iconify_icons_ic_twotone_assessment__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_assessment__WEBPACK_IMPORTED_MODULE_3__);
      /* harmony import */
      ...
      var _iconify_icons_ic_twotone_contacts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-contacts */
      "rbx1");
      /* harmony import */


      var _iconify_icons_ic_twotone_contacts__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_contacts__WEBPACK_IMPORTED_MODULE_7__);
      /* harmony import */


      var _iconify_icons_ic_twotone_layers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! @iconify/icons-ic/twotone-layers */
      "7nbV");
      /* harmony import */


      var _iconify_icons_ic_twotone_layers__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_layers__WEBPACK_IMPORTED_MODULE_8__);
      /* harmony import */


      var _popover_popover_ref__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../popover/popover-ref */
      "QaI9");
      ...
      MegaMenuComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    function pfe1(module, __webpack_exports__, __webpack_require__) {
      ...
      var NoAuthGuard = /*#__PURE__*/function () {
        function NoAuthGuard(router, tokenService) {
    ...
    /***/
    function rTLG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function rpPS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var Header = /*#__PURE__*/function (_request_component__W5) {
        _inherits(Header, _request_component__W5);
        ...
        function Header(header) {
          ...
          _this47 = _super5.call(this, 1, header.id);
          _this47.name = header.name;
          _this47.value = header.value;
          _this47.aliasName = header.alias_name;
          _this47.isRequired = header.is_required;
          return _this47;
        }
    ...
    /***/
    function sh9p(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ti5q(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "QueryParamNameResource", function () {
        return QueryParamNameResource;
      });
      /* harmony import */
      ...
      var QueryParamNameResource = /*#__PURE__*/function () {
        function QueryParamNameResource(restApi) {
          _classCallCheck(this, QueryParamNameResource);
        ...
        _createClass(QueryParamNameResource, [{
          key: "index",
          value: function index(endpointId, queryParams) {
            if (typeof endpointId === 'object') {
              queryParams = endpointId;
      ...
      QueryParamNameResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      QueryParamNameResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    /***/
    function tpJP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var Alias = function Alias(alias) {
    ...
    /***/
    function u7xO(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var QueryParam = /*#__PURE__*/function (_request_component__W6) {
        _inherits(QueryParam, _request_component__W6);

        var _super6 = _createSuper(QueryParam);

        function QueryParam(queryParam) {
          var _this48;

          _classCallCheck(this, QueryParam);

          _this48 = _super6.call(this, 3, queryParam.id, queryParam.alias);
          _this48.name = queryParam.name;
          _this48.value = queryParam.value;
          _this48.aliasName = queryParam.alias_name;
          _this48.isRequired = queryParam.is_required;
          return _this48;
        }
    ...
    /***/
    function vAmI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _agent_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./agent.service */
      "/JUU");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "AgentService", function () {
        return _agent_service__WEBPACK_IMPORTED_MODULE_0__["AgentService"];
      });
      /* harmony import */


      var _alias_resource_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      __webpack_require__.d(__webpack_exports__, "AliasResource", function () {
        return _alias_resource_service__WEBPACK_IMPORTED_MODULE_1__["AliasResource"];
      });
      /* harmony import */


      var _alias_value_resource_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./alias-value-resource.service */
      "oFyy");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "AliasValueResource", function () {
        return _alias_value_resource_service__WEBPACK_IMPORTED_MODULE_2__["AliasValueResource"];
      });
      /* harmony import */


      var _body_param_name_resource_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./body-param-name-resource.service */
      "A/vA");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "BodyParamNameResource", function () {
        return _body_param_name_resource_service__WEBPACK_IMPORTED_MODULE_3__["BodyParamNameResource"];
      });
      /* harmony import */


      var _body_param_resource_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./body-param-resource.service */
      "npeK");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "BodyParamResource", function () {
        return _body_param_resource_service__WEBPACK_IMPORTED_MODULE_4__["BodyParamResource"];
      });
      /* harmony import */


      var _endpoint_resource_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      __webpack_require__.d(__webpack_exports__, "EndpointResource", function () {
        return _endpoint_resource_service__WEBPACK_IMPORTED_MODULE_5__["EndpointResource"];
      });
      /* harmony import */


      var _header_name_resource_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./header-name-resource.service */
      "B1Wa");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "HeaderNameResource", function () {
        return _header_name_resource_service__WEBPACK_IMPORTED_MODULE_6__["HeaderNameResource"];
      });
      /* harmony import */


      var _header_resource_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      __webpack_require__.d(__webpack_exports__, "HeaderResource", function () {
        return _header_resource_service__WEBPACK_IMPORTED_MODULE_7__["HeaderResource"];
      });
      /* harmony import */
      ...
      var _omniauth_callbacks_api_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./omniauth-callbacks-api.service */
      "RdP6");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "OmniauthCallbacksApi", function () {
        return _omniauth_callbacks_api_service__WEBPACK_IMPORTED_MODULE_9__["OmniauthCallbacksApi"];
      });
      /* harmony import */


      var _organization_resource_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./organization-resource.service */
      "wjWB");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "OrganizationResource", function () {
        return _organization_resource_service__WEBPACK_IMPORTED_MODULE_10__["OrganizationResource"];
      });
      /* harmony import */


      var _organizations_user_resource_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./organizations-user-resource.service */
      "YCZM");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "OrganizationsUserResource", function () {
        return _organizations_user_resource_service__WEBPACK_IMPORTED_MODULE_11__["OrganizationsUserResource"];
      });
      /* harmony import */


      var _path_segment_name_resource_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./path-segment-name-resource.service */
      "hX/M");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "PathSegmentNameResource", function () {
        return _path_segment_name_resource_service__WEBPACK_IMPORTED_MODULE_12__["PathSegmentNameResource"];
      });
      /* harmony import */


      var _path_segment_resource_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./path-segment-resource.service */
      "Cq9o");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "PathSegmentResource", function () {
        return _path_segment_resource_service__WEBPACK_IMPORTED_MODULE_13__["PathSegmentResource"];
      });
      /* harmony import */


      var _payment_method_resource_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./payment-method-resource.service */
      "z1g2");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "PaymentMethodResource", function () {
        return _payment_method_resource_service__WEBPACK_IMPORTED_MODULE_14__["PaymentMethodResource"];
      });
      /* harmony import */


      var _plan_resource_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      ...
      __webpack_require__.d(__webpack_exports__, "PlanResource", function () {
        return _plan_resource_service__WEBPACK_IMPORTED_MODULE_15__["PlanResource"];
      });
      /* harmony import */


      var _project_resource_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      ...
      __webpack_require__.d(__webpack_exports__, "ProjectResource", function () {
        return _project_resource_service__WEBPACK_IMPORTED_MODULE_16__["ProjectResource"];
      });
      /* harmony import */


      var _projects_user_resource_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./projects-user-resource.service */
      "XTWy");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "ProjectsUserResource", function () {
        return _projects_user_resource_service__WEBPACK_IMPORTED_MODULE_17__["ProjectsUserResource"];
      });
      /* harmony import */


      var _query_param_name_resource_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ./query-param-name-resource.service */
      "ti5q");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "QueryParamNameResource", function () {
        return _query_param_name_resource_service__WEBPACK_IMPORTED_MODULE_18__["QueryParamNameResource"];
      });
      /* harmony import */


      var _query_param_resource_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! ./query-param-resource.service */
      "kqhm");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "QueryParamResource", function () {
        return _query_param_resource_service__WEBPACK_IMPORTED_MODULE_19__["QueryParamResource"];
      });
      /* harmony import */


      var _request_resource_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      ...
      __webpack_require__.d(__webpack_exports__, "RequestResource", function () {
        return _request_resource_service__WEBPACK_IMPORTED_MODULE_20__["RequestResource"];
      });
      /* harmony import */


      var _response_resolver_resource_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ./response-resolver-resource.service */
      "3aTg");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "ResponseResolverResource", function () {
        return _response_resolver_resource_service__WEBPACK_IMPORTED_MODULE_21__["ResponseResolverResource"];
      });
      /* harmony import */


      var _response_resource_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ./response-resource.service */
      "z06h");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "ResponseResource", function () {
        return _response_resource_service__WEBPACK_IMPORTED_MODULE_22__["ResponseResource"];
      });
      /* harmony import */


      var _response_header_resource_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
      /*! ./response-header-resource.service */
      "n/pC");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "ResponseHeaderResource", function () {
        return _response_header_resource_service__WEBPACK_IMPORTED_MODULE_23__["ResponseHeaderResource"];
      });
      /* harmony import */


      var _scenario_resource_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
      ...
      __webpack_require__.d(__webpack_exports__, "ScenarioResource", function () {
        return _scenario_resource_service__WEBPACK_IMPORTED_MODULE_24__["ScenarioResource"];
      });
      /* harmony import */


      var _subscription_resource_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      ...
      __webpack_require__.d(__webpack_exports__, "SubscriptionResource", function () {
        return _subscription_resource_service__WEBPACK_IMPORTED_MODULE_25__["SubscriptionResource"];
      });
      /* harmony import */


      var _user_resource_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
      ...
      __webpack_require__.d(__webpack_exports__, "UserResource", function () {
        return _user_resource_service__WEBPACK_IMPORTED_MODULE_26__["UserResource"];
      });
      /***/
    ...
    function vY5A(module, __webpack_exports__, __webpack_require__) {
      ...
      var _core_guards_no_auth_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @core/guards/no-auth.guard */
      "pfe1");
      /* harmony import */


      var _layout_custom_layout_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var routes = [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("common"), __webpack_require__.e("subscriptions-subscriptions-module")]).then(__webpack_require__.bind(null,
            /*! @subscriptions/subscriptions.module */
            "XtcF")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("default~aliases-aliases-module~auth-pages-login-login-module~auth-pages-register-register-module~end~16c71568"), __webpack_require__.e("common"), __webpack_require__.e("auth-pages-login-login-module")]).then(__webpack_require__.bind(null,
          /*! @auth/pages/login/login.module */
          "ZFij")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("default~aliases-aliases-module~auth-pages-login-login-module~auth-pages-register-register-module~end~16c71568"), __webpack_require__.e("common"), __webpack_require__.e("auth-pages-register-register-module")]).then(__webpack_require__.bind(null,
          /*! @auth/pages/register/register.module */
          "1TiS")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | auth-pages-forgot-password-forgot-password-module */
          "auth-pages-forgot-password-forgot-password-module").then(__webpack_require__.bind(null,
          /*! @auth/pages/forgot-password/forgot-password.module */
          "iXA7")).then(function (m) {
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~aliases-aliases-module~auth-pages-login-login-module~auth-pages-register-register-module~end~16c71568"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~eb28f6f5"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~11ec6de4"), __webpack_require__.e("default~organizations-organizations-module~projects-projects-module~requests-requests-module~scenari~04d380cf"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~79418c77"), __webpack_require__.e("default~organizations-organizations-module~projects-projects-module~users-users-module"), __webpack_require__.e("common"), __webpack_require__.e("projects-projects-module")]).then(__webpack_require__.bind(null,
            /*! @projects/projects.module */
            "l1Fo")).then(function (m) {
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | scenarios-scenarios-module */
            [__webpack_require__.e("default~aliases-aliases-module~auth-pages-login-login-module~auth-pages-register-register-module~end~16c71568"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~eb28f6f5"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~11ec6de4"), __webpack_require__.e("default~organizations-organizations-module~projects-projects-module~requests-requests-module~scenari~04d380cf"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~79418c77"), __webpack_require__.e("default~endpoints-endpoints-module~requests-requests-module~scenarios-scenarios-module"), __webpack_require__.e("default~requests-requests-module~scenarios-scenarios-module~subscriptions-pages-buy-buy-module"), __webpack_require__.e("default~requests-requests-module~scenarios-scenarios-module"), __webpack_require__.e("scenarios-scenarios-module")]).then(__webpack_require__.bind(null,
            /*! @scenarios/scenarios.module */
            "Bavy")).then(function (m) {
              return m.ScenariosModule;
            });
          },
          canActivate: [_core_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
        }]
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~aliases-aliases-module~auth-pages-login-login-module~auth-pages-register-register-module~end~16c71568"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~eb28f6f5"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~11ec6de4"), __webpack_require__.e("default~organizations-organizations-module~projects-projects-module~requests-requests-module~scenari~04d380cf"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~79418c77"), __webpack_require__.e("default~endpoints-endpoints-module~requests-requests-module~scenarios-scenarios-module"), __webpack_require__.e("default~requests-requests-module~scenarios-scenarios-module~subscriptions-pages-buy-buy-module"), __webpack_require__.e("default~requests-requests-module~scenarios-scenarios-module"), __webpack_require__.e("requests-requests-module")]).then(__webpack_require__.bind(null,
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | endpoints-endpoints-module */
            [__webpack_require__.e("default~aliases-aliases-module~auth-pages-login-login-module~auth-pages-register-register-module~end~16c71568"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~eb28f6f5"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~11ec6de4"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~79418c77"), __webpack_require__.e("default~endpoints-endpoints-module~requests-requests-module~scenarios-scenarios-module"), __webpack_require__.e("endpoints-endpoints-module")]).then(__webpack_require__.bind(null,
            /*! @endpoints/endpoints.module */
            "a5rT")).then(function (m) {
              return m.EndpointsModule;
            });
          },
          canActivate: [_core_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
        }]
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | aliases-aliases-module */
            [__webpack_require__.e("default~aliases-aliases-module~auth-pages-login-login-module~auth-pages-register-register-module~end~16c71568"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~eb28f6f5"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~11ec6de4"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~79418c77"), __webpack_require__.e("aliases-aliases-module")]).then(__webpack_require__.bind(null,
            /*! @aliases/aliases.module */
            "jfiX")).then(function (m) {
              return m.AliasesModule;
            });
          },
          canActivate: [_core_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
        }]
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~aliases-aliases-module~auth-pages-login-login-module~auth-pages-register-register-module~end~16c71568"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~eb28f6f5"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~11ec6de4"), __webpack_require__.e("default~organizations-organizations-module~projects-projects-module~requests-requests-module~scenari~04d380cf"), __webpack_require__.e("default~organizations-organizations-module~projects-projects-module~users-users-module"), __webpack_require__.e("default~organizations-organizations-module~subscriptions-pages-buy-buy-module~users-users-module"), __webpack_require__.e("common"), __webpack_require__.e("users-users-module")]).then(__webpack_require__.bind(null,
            /*! @users/users.module */
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            return Promise.all(
            /*! import() | organizations-organizations-module */
            [__webpack_require__.e("default~aliases-aliases-module~auth-pages-login-login-module~auth-pages-register-register-module~end~16c71568"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~eb28f6f5"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~11ec6de4"), __webpack_require__.e("default~organizations-organizations-module~projects-projects-module~requests-requests-module~scenari~04d380cf"), __webpack_require__.e("default~aliases-aliases-module~endpoints-endpoints-module~organizations-organizations-module~project~79418c77"), __webpack_require__.e("default~organizations-organizations-module~projects-projects-module~users-users-module"), __webpack_require__.e("default~organizations-organizations-module~subscriptions-pages-buy-buy-module~users-users-module"), __webpack_require__.e("common"), __webpack_require__.e("organizations-organizations-module")]).then(__webpack_require__.bind(null,
            /*! @organizations/organizations.module */
            "fBQL")).then(function (m) {
              return m.OrganizationsModule;
            });
          },
          canActivate: [_core_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
        }]
    ...
    /***/
    function vuK5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var PaymentMethod = function PaymentMethod(paymentMethod) {
      ...
      var PaymentMethodCard = function PaymentMethodCard(card) {
    ...
    /***/
    function wZfh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RouteConstants", function () {
        return RouteConstants;
      });

      var RouteConstants = function RouteConstants() {
        _classCallCheck(this, RouteConstants);
      };
    ...
    /***/
    function whvR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ToolbarProxySettingsModule", function () {
        return ToolbarProxySettingsModule;
      });
      /* harmony import */
      ...
      var _vex_pipes_relative_date_time_relative_date_time_module__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! @vex/pipes/relative-date-time/relative-date-time.module */
      "h4uD");
      /* harmony import */
      ...
      var _components_toolbar_mock_settings_toolbar_mock_settings_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ./components/toolbar-mock-settings/toolbar-mock-settings.component */
      "FYDM");
      /* harmony import */


      var _components_toolbar_record_settings_toolbar_record_settings_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ./components/toolbar-record-settings/toolbar-record-settings.component */
      "f/93");
      /* harmony import */


      var _toolbar_proxy_settings_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ./toolbar-proxy-settings.component */
      "N/jG");

      var ToolbarProxySettingsModule = function ToolbarProxySettingsModule() {
        _classCallCheck(this, ToolbarProxySettingsModule);
      };

      ToolbarProxySettingsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_components_toolbar_mock_settings_toolbar_mock_settings_component__WEBPACK_IMPORTED_MODULE_20__["ToolbarMockSettingsComponent"], _toolbar_proxy_settings_component__WEBPACK_IMPORTED_MODULE_22__["ToolbarProxySettingsComponent"], _components_toolbar_record_settings_toolbar_record_settings_component__WEBPACK_IMPORTED_MODULE_21__["ToolbarRecordSettingsComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_8__["MatDialogModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_9__["MatDividerModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_11__["MatIconModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_12__["MatInputModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_10__["MatFormFieldModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_13__["MatMenuModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_7__["MatRippleModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_14__["MatSelectModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_15__["MatSnackBarModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_16__["MatTabsModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_17__["MatTooltipModule"], _vex_pipes_relative_date_time_relative_date_time_module__WEBPACK_IMPORTED_MODULE_18__["RelativeDateTimeModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_19__["IconModule"]],
        exports: [_toolbar_proxy_settings_component__WEBPACK_IMPORTED_MODULE_22__["ToolbarProxySettingsComponent"]],
        entryComponents: [_components_toolbar_mock_settings_toolbar_mock_settings_component__WEBPACK_IMPORTED_MODULE_20__["ToolbarMockSettingsComponent"], _components_toolbar_record_settings_toolbar_record_settings_component__WEBPACK_IMPORTED_MODULE_21__["ToolbarRecordSettingsComponent"]]
    ...
    /***/
    function wjWB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var OrganizationResource = /*#__PURE__*/function () {
        function OrganizationResource(restApi) {
        ...
        _createClass(OrganizationResource, [{
          ...
          key: "subscription",
          value: function subscription(id, queryParams) {
            return this.restApi.index([this.ENDPOINT, id, 'subscription'], queryParams);
          }
        }, {
          key: "payments",
          value: function payments(id, queryParams) {
      ...
      OrganizationResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      OrganizationResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    /***/
    function wuZS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function xPQ(module, __webpack_exports__, __webpack_require__) {
      ...
      var _search_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ngx-take-until-destroy */
      "DnKK");
      /* harmony import */
      ...
      var _services_search_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var SearchComponent = /*#__PURE__*/function () {
        ...
        _createClass(SearchComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.searchCtrl.valueChanges.pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_6__["untilDestroyed"])(this)).subscribe(function (value) {
              return _this49.searchService.valueChangesSubject.next(value);
            });
            this.show$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (show) {
              return show;
            }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_6__["untilDestroyed"])(this)).subscribe(function () {
              return _this49.input.nativeElement.focus();
            });
          }
        }, {
          key: "close",
    ...
    /***/
    function xDFx(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function yVwa(module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_navigation_item_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./navigation-item.component.html */
      "sh9p");
      /* harmony import */


      var _navigation_item_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _utils_track_by__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../utils/track-by */
      "zK3P");
      ...
      var NavigationItemComponent = /*#__PURE__*/function () {
        function NavigationItemComponent(navigationService, router) {
          ...
          this.navigationService = navigationService;
          this.router = router;
          this.isActive$ = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (event) {
            return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["NavigationEnd"];
            ...
            return function (item) {
              return _this50.hasActiveChilds(item);
            };
          }));
          ...
          value: function hasActiveChilds(parent) {
            ...
            if (this.isDropdown(parent) || this.isSubheading(parent)) {
              return parent.children.some(function (child) {
                if (_this51.isDropdown(child)) {
                  return _this51.hasActiveChilds(child);
                }

                if (_this51.isLink(child) && !_this51.isFunction(child.route)) {
                  return _this51.router.isActive(child.route, false);
                }
      ...
      NavigationItemComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    function ycnu(module, __webpack_exports__, __webpack_require__) {
      ...
      var _navigation_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      NavigationModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_4__["MatRippleModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_6__["MatMenuModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_5__["MatIconModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_8__["IconModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"], _components_navigation_item_navigation_item_module__WEBPACK_IMPORTED_MODULE_9__["NavigationItemModule"], _directives_container_container_module__WEBPACK_IMPORTED_MODULE_10__["ContainerModule"]],
    ...
    function ynKk(module, __webpack_exports__, __webpack_require__) {
      ...
      var _utils_check_router_childs_data__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ../utils/check-router-childs-data */
      "3TZW");
      /* harmony import */


      var _utils_tailwindcss__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ../utils/tailwindcss */
      "XXSj");
      ...
      var LayoutComponent = /*#__PURE__*/function () {
        function LayoutComponent(cd, breakpointObserver, layoutService, configService, router, document) {
          ...
          this.router = router;
          this.document = document;
          this.isLayoutVertical$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (config) {
            return config.layout === 'vertical';
          }));
          this.isBoxed$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (config) {
            return config.boxed;
          }));
          this.isToolbarFixed$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (config) {
            return config.toolbar.fixed;
          }));
          this.isFooterFixed$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (config) {
            return config.footer.fixed;
          }));
          this.isFooterVisible$ = this.configService.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (config) {
            return config.footer.visible;
          }));
          this.sidenavCollapsed$ = this.layoutService.sidenavCollapsed$;
          this.sidenavCollapsedOpen$ = this.layoutService.sidenavCollapsedOpen$;
          this.sidenavOpen$ = this.layoutService.sidenavOpen$;
          this.isDesktop$ = this.breakpointObserver.observe("(min-width: ".concat(_utils_tailwindcss__WEBPACK_IMPORTED_MODULE_13__["default"].screens.lg, ")")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (state) {
            return state.matches;
          }));
          this.scrollDisabled$ = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["filter"])(function (event) {
            return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_7__["NavigationEnd"];
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function () {
            return Object(_utils_check_router_childs_data__WEBPACK_IMPORTED_MODULE_12__["checkRouterChildsData"])(_this52.router.routerState.root.snapshot, function (data) {
              return data.scrollDisabled;
            });
          }));
          this.containerEnabled$ = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["filter"])(function (event) {
            return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_7__["NavigationEnd"];
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function () {
            return Object(_utils_check_router_childs_data__WEBPACK_IMPORTED_MODULE_12__["checkRouterChildsData"])(_this52.router.routerState.root.snapshot, function (data) {
        ...
        _createClass(LayoutComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.layoutService.quickpanelOpen$.pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_8__["untilDestroyed"])(this)).subscribe(function (open) {
              return open ? _this53.quickpanel.open() : _this53.quickpanel.close();
            });
            this.layoutService.sidenavOpen$.pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_8__["untilDestroyed"])(this)).subscribe(function (open) {
              return open ? _this53.sidenav.open() : _this53.sidenav.close();
            });
            this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["filter"])(function (event) {
              return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_7__["NavigationEnd"];
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["withLatestFrom"])(this.isDesktop$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["filter"])(function (_ref10) {
              var _ref11 = _slicedToArray(_ref10, 2),
                  event = _ref11[0],
                  matches = _ref11[1];

              return !matches;
            }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_8__["untilDestroyed"])(this)).subscribe(function () {
              return _this53.sidenav.close();
            });
          }
        }, {
          key: "ngAfterViewInit",
          value: function ngAfterViewInit() {
            ...
            this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["filter"])(function (e) {
              return e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_7__["Scroll"];
            }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_8__["untilDestroyed"])(this)).subscribe(function (e) {
              if (e.position) {
                // backward navigation
                _this54.sidenavContainer.scrollable.scrollTo({
                  start: e.position[0],
                  top: e.position[1]
                });
              } else if (e.anchor) {
                ...
                var scroll = function scroll(anchor) {
                  return _this54.sidenavContainer.scrollable.scrollTo({
                    behavior: 'smooth',
                ...
                var anchorElem = _this54.document.getElementById(e.anchor);

                if (anchorElem) {
                  scroll(anchorElem);
                } else {
                  setTimeout(function () {
                    anchorElem = _this54.document.getElementById(e.anchor);
                    scroll(anchorElem);
                  }, 100);
                }
              } else {
      ...
      LayoutComponent.propDecorators = {
        ...
        sidenavContainer: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_5__["ViewChild"],
          args: [_angular_material_sidenav__WEBPACK_IMPORTED_MODULE_6__["MatSidenavContainer"], {
            "static": true
          }]
        }]
      };
      LayoutComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["Component"])({
        selector: 'vex-layout',
    ...
    /***/
    function z06h(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ResponseResource = /*#__PURE__*/function () {
        function ResponseResource(restApi) {
          _classCallCheck(this, ResponseResource);
      ...
      ResponseResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      ResponseResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], ResponseResource);
      /***/
    },
    ...
    /***/
    function z1g2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var PaymentMethodResource = /*#__PURE__*/function () {
        function PaymentMethodResource(restApi) {
          _classCallCheck(this, PaymentMethodResource);

          this.restApi = restApi;
          this.ENDPOINT = 'payment_methods';
        }

        _createClass(PaymentMethodResource, [{
          key: "index",
          value: function index(queryParams) {
            return this.restApi.index([this.ENDPOINT], queryParams);
          }
      ...
      PaymentMethodResource.ctorParameters = function () {
        return [{
          type: _rest_api_service__WEBPACK_IMPORTED_MODULE_2__["RestApiService"]
        }];
      };

      PaymentMethodResource = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    /***/
    function z6XH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function zaci(module, __webpack_exports__, __webpack_require__) {
      ...
      SidebarModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]],
    ...
    /***/
    function zd1o(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_sidenav_item_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./sidenav-item.component.html */
      "d5u2");
      /* harmony import */


      var _sidenav_item_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _animations_dropdown_animation__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
        ...
        _createClass(SidenavItemComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (event) {
              return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["NavigationEnd"];
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function () {
              return _this55.isDropdown(_this55.item);
            }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_6__["untilDestroyed"])(this)).subscribe(function () {
              return _this55.onRouteChange();
            });
            this.navigationService.openChange$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function () {
              return _this55.isDropdown(_this55.item);
            }), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_6__["untilDestroyed"])(this)).subscribe(function (item) {
              return _this55.onOpenChange(item);
            });
          ...
          value: function isChildrenOf(parent, item) {
            ...
            return parent.children.filter(function (child) {
              return _this56.isDropdown(child);
            }).some(function (child) {
              return _this56.isChildrenOf(child, item);
            });
          }
        }, {
          key: "hasActiveChilds",
          value: function hasActiveChilds(parent) {
            ...
            return parent.children.some(function (child) {
              if (_this57.isDropdown(child)) {
                return _this57.hasActiveChilds(child);
              }

              if (_this57.isLink(child) && !_this57.isFunction(child.route)) {
                return _this57.router.isActive(child.route, false);
              }
            });
          }
        }, {
      ...
      SidenavItemComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
