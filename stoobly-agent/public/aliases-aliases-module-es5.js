        ...
        _createClass(ProjectResolver, [{
          ...
          value: function resolve(route) {
            ...
            return this.projectResource.show(projectId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (project) {
              _this8.projectDataService.set(new _data_schema_project__WEBPACK_IMPORTED_MODULE_4__["Project"](project));
            }));
          }
        }]);
        ...
        _createClass(AliasDetailsComponent, [{
          ...
          value: function openAliasValueCreateDialog($event) {
            ...
            var onCreateSub = dialogRef.componentInstance.onCreate.subscribe(function ($event) {
              _this9.createAliasValue($event.value);
            });
          ...
          value: function createAliasValue(value) {
            ...
            this.aliasValueResource.create(aliasValue).subscribe(function (res) {
              _this10.aliasValueData = _this10.aliasValueData.concat(new _data_schema__WEBPACK_IMPORTED_MODULE_12__["AliasValue"](aliasValue));
            });
          }
        }, {
          ...
          value: function deleteAliasValue(aliasValues) {
            ...
            aliasValues.forEach(function (aliasValue) {
              ...
              _this11.aliasValueResource.destroy(aliasValueId).subscribe(function (res) {
                _this11.aliasValueData = _this11.aliasValueData.filter(function (candidate) {
