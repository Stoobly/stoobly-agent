...
from ...constants import PROXY_MODE_REVERSE, WORKFLOW_DEVELOP_TYPE, WORKFLOW_MOCK_TYPE, WORKFLOW_RECORD_TYPE, WORKFLOW_TEST_TYPE
...
def get_workflow_decorators(workflow: str, service_config: ServiceConfig):
  ...
  if workflow == WORKFLOW_RECORD_TYPE or workflow == WORKFLOW_DEVELOP_TYPE:
