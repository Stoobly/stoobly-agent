...
CORE_MOCK_UI_SERVICE_NAME = 'stoobly_ui'
...
CORE_LOCAL_PROXY_SERVICE_NAME = 'proxy'
CORE_SERVICES_LOCAL = [
  CORE_LOCAL_PROXY_SERVICE_NAME
]
...
NORMALIZE_WORKFLOW_MAINTAINED_FILES = []

NORMALIZE_WORKFLOW_CUSTOM_FILES = [
  CUSTOM_BUILD,
  CUSTOM_INIT,
  CUSTOM_LIFECYCLE_HOOKS,
]

NORMALIZE_WORKFLOW_CUSTOM_LOCAL_FILES = [
  CUSTOM_RUN,
]

NORMALIZE_WORKFLOW_CUSTOM_DOCKER_FILES = [
  CUSTOM_DOCKER_COMPOSE,
]
...
# Service extensions for Docker Compose files
INIT_SERVICE_EXTENSION = '.init'
PROXY_SERVICE_EXTENSION = '.proxy'
