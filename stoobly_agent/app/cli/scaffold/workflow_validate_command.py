...
class WorkflowValidateCommand(WorkflowCommand, ValidateCommand):
  ...
  def validate_core_components(self):
    ...
    gateway_container_name = self.managed_services_docker_compose.core_gateway_container_name
    ...
    mock_ui_container_name = self.managed_services_docker_compose.core_mock_ui_container_name
  ...
  def validate_no_core_components(self):
    try:
      core_gateway_container = self.docker_client.containers.get(self.managed_services_docker_compose.core_gateway_container_name)
    ...
    try:
      core_mock_ui_container_name = self.docker_client.containers.get(self.managed_services_docker_compose.core_mock_ui_container_name)
  ...
  def validate(self) -> bool:
    ...
    self.validate_init_containers(self.managed_services_docker_compose.core_init_container_name, self.managed_services_docker_compose.core_configure_container_name)

    print(f"Validating core component: {CORE_ENTRYPOINT_SERVICE_NAME}")

    try:
      core_entrypoint_init_container_name = self.managed_services_docker_compose.core_entrypoint_init_container_name
    ...
    try:
      core_entrypoint_configure_container_name = self.managed_services_docker_compose.core_entrypoint_configure_container_name
