...
def synchronize_request(request: Request, endpoint: EndpointShowResponse):
  ...
  synchronize_component(query_param_names_facade, mitmproxy_request.query)
  ...
  synchronize_component(body_param_names_facade, body_params)
...
def synchronize_component(facade: RequestComponentNamesFacade, component):
  context = __context()
...
def __context():
  ...
  return TestContextMock(__lifecycle_hooks())

def __lifecycle_hooks():
  handler = RequestSynchronizeHandler()
  hooks = {}
