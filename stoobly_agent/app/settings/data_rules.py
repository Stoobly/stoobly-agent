from stoobly_agent.config.constants import mock_policy, develop_policy, record_order, record_policy, record_strategy, test_strategy, test_policy
...
class DataRules:
  ...
  def __init__(self, data_rules: IDataRules):
    ...
    self.__develop_policy = self.__data_rules.get('develop_policy') or develop_policy.ALL
  ...
  def develop_policy(self):
    return self.__develop_policy

  @develop_policy.setter
  def develop_policy(self, v):
    self.__develop_policy = v
    self.__data_rules['develop_policy'] = v
  ...
  def to_dict(self) -> IDataRules:
    return {
      ...
      'develop_policy': self.__develop_policy,
