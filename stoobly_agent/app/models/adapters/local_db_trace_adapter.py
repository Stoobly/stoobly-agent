...
from stoobly_agent.lib.api.interfaces import TraceShowResponse
...
class LocalDBRequestAdapter():
  ...
  def create(self, **params: RequestCreateParams) -> TraceShowResponse:
  ...
  def show(self, trace_id: str) -> Union[TraceShowResponse, None]:
    trace_record = self.__request_orm.find(trace_id)
