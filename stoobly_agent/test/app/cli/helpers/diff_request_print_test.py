...
class _StubCurrentReq:
    def __init__(
        self, url=None, body=None, headers=None, res_content=None, res_headers=None
    ):
        self.url = url
...
@pytest.mark.parametrize(
    "snap_body,cur_body,expected_any",
    [
...
def test_request_body_one_sided_and_diff_detection(
    snap_body, cur_body, expected_any, monkeypatch
):
    ...
    monkeypatch.setattr(
        "stoobly_agent.app.models.adapters.orm.OrmResponseAdapterFactory",
        _FakeRespAdapter,
    )
